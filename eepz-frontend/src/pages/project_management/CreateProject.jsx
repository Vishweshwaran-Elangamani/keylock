// src/pages/ProjectManagement/CreateProject.jsx
  ...
  const CustomSelect = ({ label, name, value, onChange, options, error, required, placeholder }) => (
    <div className="mb-3">
      ...
      <div style={{ position: 'relative' }}>
        ...
        >
          <option value="" style={{ color: 'var(--muted)' }}>{placeholder}</option>
          {options.map((opt, idx) => (
            <option key={idx} value={opt.value || opt} style={{ color: 'var(--color-primary-2)' }}>
              {opt.label || opt}
            </option>
          ))}
        </select>
      ...
      {error && <div style={{ color: '#E01950', fontSize: '0.85rem', marginTop: '0.25rem' }}>{error}</div>}
    </div>
  );
    ...
    <div className="h-100 d-flex flex-column">
      ...
      <div className="d-flex align-items-center justify-content-between mb-4">
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            <h2 className="mb-0 fw-bold" style={{ color: 'var(--color-primary-1)' }}>
              Create New Project
            </h2>
      ...
      {submitStatus && (
        <div 
          ...
          role="alert"
          style={{
            backgroundColor: submitStatus.type === 'success' ? 'rgba(36, 161, 72, 0.1)' : 'rgba(224, 25, 80, 0.1)',
            border: `1px solid ${submitStatus.type === 'success' ? '#24A148' : '#E01950'}`,
      ...
      {/* Form Card */}
      <div className="card border-0 flex-grow-1" style={{
        ...
        <div className="card-body p-4 overflow-auto">
          <form onSubmit={handleSubmit} className="h-100 d-flex flex-column">
            <div className="flex-grow-1">
              {/* Basic Information */}
              <div className="mb-4">
                <h5 className="fw-bold mb-3 pb-2" style={{ 
                ...
                <div className="row g-3">
                  <div className="col-md-6">
                    <label className="form-label" style={{ color: 'var(--color-primary-2)', fontWeight: '500', fontSize: '0.9rem' }}>
                    ...
                    <input
                      ...
                      style={{
                        borderColor: errors.projectName ? '#E01950' : 'var(--border)',
                        borderRadius: '8px',
                    ...
                    <div className="form-text" style={{ fontSize: '0.85rem' }}>
                      Use format <strong>ORG.(Dept).(Project)</strong> — letters/numbers/hyphen only. No spaces.
                    </div>
                    {errors.projectName && (
                      <div style={{ color: '#E01950', fontSize: '0.85rem', marginTop: '0.25rem' }}>
                        {errors.projectName}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      style={{
                        borderColor: errors.clientName ? '#E01950' : 'var(--border)',
                        borderRadius: '8px',
                        padding: '0.65rem 0.75rem',
                        fontSize: '0.95rem'
                      }}
              ...
              <div className="mb-4">
                <h5 className="fw-bold mb-3 pb-2 d-flex align-items-center gap-2" style={{ 
                  borderBottom: '2px solid var(--border)',
                  color: 'var(--color-primary-1)'
                }}>
                ...
                {isLoadingData ? (
                  <div className="text-center py-4">
                    <div className="spinner-border" style={{ color: 'var(--color-primary-3)' }} />
                    <p className="mt-2" style={{ color: 'var(--muted)' }}>Loading data...</p>
                  </div>
                ) : (
                  <div className="row g-3">
                    <div className="col-md-6">
                ...
                <div className="row g-3">
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      style={{
                        borderColor: errors.startDate ? '#E01950' : 'var(--border)',
                        borderRadius: '8px',
                        padding: '0.65rem 0.75rem'
                      }}
                    />
                  ...
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      style={{
                        borderColor: errors.endDate ? '#E01950' : 'var(--border)',
                        borderRadius: '8px',
                        padding: '0.65rem 0.75rem'
                      }}
                    />
                    ...
                    <div className="col-md-4">
                      ...
                      <div 
                        ...
                        style={{ 
                          cursor: 'pointer',
                          borderColor: 'var(--border)',
                          backgroundColor: selectedResourceOwner ? 'rgba(151, 36, 126, 0.05)' : 'transparent',
                          transition: 'all 0.2s'
                        }}
                      ...
                      >
                        {selectedResourceOwner ? (
                          <div>
                            <div className="fw-semibold">{selectedResourceOwner.firstName} {selectedResourceOwner.lastName}</div>
                            <small className="text-muted">{selectedResourceOwner.roleName}</small>
                          </div>
                        ) : (
                    ...
                    <div className="col-md-4">
                      ...
                      <div 
                        ...
                        style={{ 
                          cursor: 'pointer',
                          borderColor: 'var(--border)',
                          backgroundColor: selectedL1Approver ? 'rgba(151, 36, 126, 0.05)' : 'transparent',
                          transition: 'all 0.2s'
                        }}
                      ...
                      >
                        {selectedL1Approver ? (
                          <div>
                            <div className="fw-semibold">{selectedL1Approver.firstName} {selectedL1Approver.lastName}</div>
                            <small className="text-muted">{selectedL1Approver.roleName}</small>
                          </div>
                        ) : (
                          <div className="text-muted d-flex align-items-center gap-2">
                            <UserCog size={16} />
                    ...
                    <div className="col-md-4">
                      ...
                      <div 
                        ...
                        style={{ 
                          cursor: 'pointer',
                          borderColor: 'var(--border)',
                          backgroundColor: selectedL2Approver ? 'rgba(151, 36, 126, 0.05)' : 'transparent',
                          transition: 'all 0.2s'
                        }}
                      ...
                      >
                        {selectedL2Approver ? (
                          <div>
                            <div className="fw-semibold">{selectedL2Approver.firstName} {selectedL2Approver.lastName}</div>
                            <small className="text-muted">{selectedL2Approver.roleName}</small>
                          </div>
                        ) : (
                          <div className="text-muted d-flex align-items-center gap-2">
                            <UserCog size={16} />
            ...
            {/* Form Actions */}
            <div className="d-flex gap-3 justify-content-end pt-3 mt-auto" style={{ borderTop: '1px solid var(--border)' }}>
              <button
                type="button"
                onClick={handleReset}
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title d-flex align-items-center gap-2">
                  <UserCog size={24} />
                  Select {activeManagerTab === 'resource' ? 'Resource Owner' : activeManagerTab === 'l1' ? 'L1 Approver' : 'L2 Approver'}
                </h5>
                <button type="button" className="btn-close" onClick={() => setShowManagerModal(false)}></button>
              </div>
              <div className="modal-body">
                ...
                <div className="row g-3 mb-3">
                  ...
                  <div className="col-md-3">
                    <select className="form-select" value={managerFilterRole} onChange={(e) => setManagerFilterRole(e.target.value)}>
                      <option value="All">All Roles</option>
                      {getUniqueManagerRoles().map((role, idx) => (<option key={idx} value={role}>{role}</option>))}
                    </select>
                  </div>
                  <div className="col-md-3">
                    <select className="form-select" value={managerFilterDepartment} onChange={(e) => setManagerFilterDepartment(e.target.value)}>
                      <option value="All">All Departments</option>
                      {getUniqueManagerDepartments().map((dept, idx) => (<option key={idx} value={dept}>{dept}</option>))}
                    </select>
                  </div>
                </div>
                  ...
                  <table className="table table-sm table-hover">
                    ...
                    <tbody>
                      {paginatedManagers.length === 0 ? (
                        <tr><td colSpan="4" className="text-center py-4 text-muted">No employees found</td></tr>
                      ) : (
                        paginatedManagers.map((emp) => {
                          let isSelected = false;
                          if (activeManagerTab === 'resource') isSelected = selectedResourceOwner?.employeeMasterId === emp.employeeMasterId;
                          else if (activeManagerTab === 'l1') isSelected = selectedL1Approver?.employeeMasterId === emp.employeeMasterId;
                          else if (activeManagerTab === 'l2') isSelected = selectedL2Approver?.employeeMasterId === emp.employeeMasterId;
                ...
                {managerTotalPages > 1 && (
                  <div className="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                    <div className="text-muted small">Showing {managerStartIndex + 1} to {Math.min(managerEndIndex, filteredManagers.length)} of {filteredManagers.length} employees</div>
                    <nav>
                      <ul className="pagination pagination-sm mb-0">
                        <li className={`page-item ${managerCurrentPage === 1 ? 'disabled' : ''}`}>
                          <button className="page-link" onClick={() => setManagerCurrentPage(managerCurrentPage - 1)} disabled={managerCurrentPage === 1}><ChevronLeftIcon size={14} /></button>
                        </li>
                        {getManagerPageNumbers().map((page, index) => (
                          page === '...' ? (
                            <li key={`mgr-ellipsis-${index}`} className="page-item disabled"><span className="page-link">...</span></li>
                          ) : (
                            <li key={`mgr-${page}`} className={`page-item ${managerCurrentPage === page ? 'active' : ''}`}>
                              <button className="page-link" onClick={() => goToManagerPage(page)}>{page}</button>
                            </li>
                          )
                        ))}
                        <li className={`page-item ${managerCurrentPage === managerTotalPages ? 'disabled' : ''}`}>
                          <button className="page-link" onClick={() => setManagerCurrentPage(managerCurrentPage + 1)} disabled={managerCurrentPage === managerTotalPages}><ChevronRight size={14} /></button>
                        </li>
                      </ul>
                    </nav>
                    <div className="text-muted small">Page {managerCurrentPage} of {managerTotalPages}</div>
                  </div>
                )}
              </div>
