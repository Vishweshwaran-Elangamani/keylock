...
//                             {(() => {
//                               const latestProof =
//                                 approval.proofAttachments.sort(
//                                   (a, b) =>
//                                     new Date(b.attachedOn) -
//                                     new Date(a.attachedOn)
//                                 )[0];
...
//                                         </div>
//                                         {approval.proofAttachments.length >
//                                           1 && (
//                                           <div className="mt-2">
//                                             <span
            ...
            >
              ...
              {loading ? (
                ...
                <>
                  ...
                  {/* PROOF OF COMPLETION - WITH PREVIEW AND WORKING TOOLTIPS */}
                  {(isCompletionApproval || isAcknowledgmentApproval) &&
                    hasProofAttachments && (
                      <div className="mb-4">
                        <h6
                  ...
                  {/* ALL ATTACHMENTS - WITH PREVIEW AND WORKING TOOLTIPS */}
                  {approval.allAttachments?.length > 0 && (
                    <div className="mb-4">
                      <h6 className="fw-bold mb-3" style={{ fontSize: "1rem" }}>
                        <i className="bi bi-paperclip me-2 text-secondary"></i>
