...
const MeetingInvitations = () => {
  ...
  const openRsvpModal = (invitation) => {
    ...
    const currentStatus = invitation.rsvpStatus || invitation.RSVPStatus || RSVP_STATUS.PENDING;
    const validStatuses = Object.values(RSVP_STATUS);
    setRsvpStatus(validStatuses.includes(currentStatus) ? currentStatus : RSVP_STATUS.ACCEPTED);
        ...
        <div className="col-lg-10 col-xl-9">
          ...
          <div className="d-flex align-items-center gap-3 mb-4 flex-wrap">
            ...
            <div className="d-flex align-items-center gap-2 px-3 py-2 bg-white rounded border">
              ...
              <div>
                <div className="fw-bold" style={{ fontSize: '1.25rem' }}>{invitations.length}</div>
          ...
          {invitations.length === 0 ? (
            <div className="card border-0 shadow-sm">
              <div className="card-body text-center py-5">
                ...
                <p className="text-muted mb-0">You have no pending meeting invitations at this time.</p>
              </div>
            </div>
          ) : (
            /* Invitations List */
            <div className="row g-3">
              {invitations.map((inv, index) => {
                ...
                const meetingTitle = getField(inv, 'meetingTitle', 'MeetingTitle') || 'Untitled Meeting';
                const meetingDate = getField(inv, 'meetingDate', 'MeetingDate');
                const rsvpStatus = getField(inv, 'rsvpStatus', 'RSVPStatus') || RSVP_STATUS.PENDING;
                const invitedAt = getField(inv, 'invitedAt', 'InvitedAt');
                const schedulerName = getField(inv, 'schedulerName', 'SchedulerName', 'organizerName', 'OrganizerName');
                        ...
                        <div className="row align-items-start">
                          ...
                          <div className="col">
                            ...
                            <div className="row g-3">
                              {schedulerName && (
                                <div className="col-md-4">
                                  <div className="d-flex align-items-start gap-2">
                                    <User size={18} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                                    <div>
                              ...
                              <div className={schedulerName ? "col-md-8" : "col-md-6"}>
                                <div className="d-flex align-items-start gap-2">
                                  <Clock size={18} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                                  <div>
                                    <div className="text-muted fw-medium" style={{ fontSize: '0.8rem' }}>
                                      Meeting Time
                                    </div>
                              ...
                              {!schedulerName && invitedAt && (
                                <div className="col-md-6">
                                  <div className="d-flex align-items-start gap-2">
                                    <Mail size={18} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                                    <div>
                                      <div className="text-muted fw-medium" style={{ fontSize: '0.8rem' }}>
                                        Invited on
                                      </div>
                ...
                <div className="modal-content border-0 shadow">
                  <div className="modal-header border-0 pb-0">
                    <div>
                      ...
                      <p className="text-muted small mb-0">Respond to meeting invitation</p>
                    </div>
                    <button type="button" className="btn-close" onClick={closeRsvpModal}></button>
                  </div>
                  ...
                  <div className="modal-body">
                    ...
                    <div className="card bg-light border-0 mb-4">
                      <div className="card-body">
                        <h6 className="fw-semibold mb-3">
                          {getField(selectedInvitation, 'meetingTitle', 'MeetingTitle') || 'Meeting Details'}
                        </h6>
                        <div className="d-flex flex-column gap-2">
                          <div className="d-flex align-items-center gap-2">
                            <Clock size={16} className="text-primary" />
                            <span style={{ fontSize: '0.9rem', color: '#1e293b' }}>
                              {formatDateTime(getField(selectedInvitation, 'meetingDate', 'MeetingDate'))}
                            </span>
                          </div>
                          
                          {getField(selectedInvitation, 'schedulerName', 'SchedulerName', 'organizerName', 'OrganizerName') && (
                            <div className="d-flex align-items-center gap-2">
                              <User size={16} className="text-primary" />
                              <span style={{ fontSize: '0.9rem', color: '#1e293b' }}>
                                Organized by <strong>{getField(selectedInvitation, 'schedulerName', 'SchedulerName', 'organizerName', 'OrganizerName')}</strong>
                              </span>
                            </div>
                          )}
                          ...
                          <div className="d-flex align-items-center gap-2">
                            ...
                            <span style={{ fontSize: '0.9rem', color: '#1e293b' }}>
                              Invited: {formatDate(getField(selectedInvitation, 'invitedAt', 'InvitedAt'))}
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    {getField(selectedInvitation, 'rsvpStatus', 'RSVPStatus') !== RSVP_STATUS.PENDING && (
                      <div className="alert alert-info d-flex align-items-start gap-2 mb-4">
                        <AlertCircle size={18} className="mt-1" style={{ flexShrink: 0 }} />
                        <div className="flex-grow-1">
                          <strong>Current Response:</strong> {getField(selectedInvitation, 'rsvpStatus', 'RSVPStatus')}
                          {getField(selectedInvitation, 'rsvpResponseDate', 'RSVPResponseDate') && (
                            <div className="text-muted small mt-1">
                              Responded on {formatDate(getField(selectedInvitation, 'rsvpResponseDate', 'RSVPResponseDate'))}
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="btn-group w-100" role="group">
                        ...
                        />
                        <label className="btn btn-outline-success" htmlFor="rsvp-accepted">
                        ...
                        <input 
                          ...
                          onChange={(e) => setRsvpStatus(e.target.value)}
                        />
                        <label className="btn btn-outline-info" htmlFor="rsvp-tentative">
                        ...
                        <input 
                          ...
                          onChange={(e) => setRsvpStatus(e.target.value)}
                        />
                        <label className="btn btn-outline-danger" htmlFor="rsvp-declined">
                    ...
                    <div className="mb-3">
                      ...
                      />
                      {getField(selectedInvitation, 'rsvpComments', 'RSVPComments') && (
                        <small className="text-muted mt-1 d-block">
                          <strong>Previous comment:</strong> "{getField(selectedInvitation, 'rsvpComments', 'RSVPComments')}"
                        </small>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="modal-footer border-0 pt-0">
                    <button className="btn btn-secondary px-4" onClick={closeRsvpModal}>
                      Cancel
                    </button>
                    <button 
