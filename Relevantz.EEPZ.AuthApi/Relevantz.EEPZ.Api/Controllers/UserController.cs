    ...
    ICurrentUserService        currentUser)
{
    ...
    public async Task<IActionResult> GetMyProfile()
    {
        ...
        return Ok(ApiResponseDto<ProfileResponseDto>.SuccessResponse(
            profile, MessageConstants.ProfileRetrievedSuccess));
    }
        ...
        [FromBody] UpdateProfileRequestDto request)
    {
        ...
        return Ok(ApiResponseDto<ProfileResponseDto>.SuccessResponse(
            updatedProfile, MessageConstants.ProfileUpdatedSuccess));
    }
        ...
        [FromForm] IFormFile ProfilePhoto)
    {
        ...
        if (ProfilePhoto.Length > maxFileSize)
            return BadRequest(
                ApiResponseDto<ProfileResponseDto>.FailureResponse(
                    MessageConstants.PhotoTooLarge));

        var request = new UpdateProfileRequestDto { ProfilePhoto = ProfilePhoto };
        var updatedProfile = await _profileService.UpdateProfileAsync(userId.Value, request);
        return Ok(ApiResponseDto<ProfileResponseDto>.SuccessResponse(
            updatedProfile, MessageConstants.PhotoUploadedSuccess));
    }
        ...
        [FromBody] CreateUserRequestDto request)
    {
        ...
        return Ok(ApiResponseDto<UserResponseDto>.SuccessResponse(
            user, MessageConstants.UserCreatedSuccess));
    }
        ...
        [FromBody] UpdateUserRequestDto request)
    {
        ...
        return Ok(ApiResponseDto<UserResponseDto>.SuccessResponse(
            user, MessageConstants.UserUpdatedSuccess));
    }
    ...
    public async Task<IActionResult> GetUserById(int id)
    {
        ...
        return Ok(ApiResponseDto<UserResponseDto>.SuccessResponse(
            user, MessageConstants.UserRetrievedSuccess));
    }
    ...
    public async Task<IActionResult> GetAllUsers()
    {
        ...
        return Ok(ApiResponseDto<List<UserResponseDto>>.SuccessResponse(
            users, MessageConstants.UsersRetrievedSuccess));
    }
    ...
    {
        // Read caller's empId from Keycloak JWT claim
        ...
        return Ok(ApiResponseDto<object>.SuccessResponse(
            null, MessageConstants.UserDeactivatedSuccess));
    }
    ...
    public async Task<IActionResult> ActivateUser(int Id)
    {
        ...
        return Ok(ApiResponseDto<object>.SuccessResponse(
            null, MessageConstants.UserActivatedSuccess));
    }
    ...
    public async Task<IActionResult> GetEmployeesByManager(int id)
    {
        ...
        return Ok(ApiResponseDto<List<UserResponseDto>>.SuccessResponse(
            employees, MessageConstants.EmployeesRetrievedSuccess));
    }
        ...
        [FromBody] AssignRoleDepartmentRequestDto request)
    {
        ...
        return Ok(ApiResponseDto<object>.SuccessResponse(
            null, MessageConstants.RoleDepartmentAssignedSuccess));
    }
    ...
    public async Task<IActionResult> GetNextEmployeeCompanyId()
    {
        ...
        return Ok(ApiResponseDto<string>.SuccessResponse(
            nextId, MessageConstants.NextEmpIdSuccess));
    }
}
