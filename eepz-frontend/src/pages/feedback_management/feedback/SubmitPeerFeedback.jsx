...
export default function SubmitPeerFeedback() {
  ...
  const submitFeedback = async (e) => {
    ...
    try {
      ...
      if (createResponse.data?.success) {
        ...
        console.log('✅ Step 2 Complete - Feedback approved:', approveResponse.data);

        if (approveResponse.data?.success || approveResponse.status === 200) {
          setSuccessMsg(`✅ Feedback submitted and approved successfully for ${selectedEmp.firstName} ${selectedEmp.lastName}!`);
          resetForm();
        } else {
          // Feedback created but approval failed - still show partial success
          setSuccessMsg(`⚠️ Feedback submitted to ${selectedEmp.firstName} ${selectedEmp.lastName}, but auto-approval failed. HR will review it.`);
          resetForm();
        }
      } else {
  ...
  return (
    <div className="container-fluid py-4" style={{ maxWidth: '1000px' }}>
      {/* HEADER */}
      <div className="mb-4">
        <h2 className="fw-bold mb-2" style={{ color: 'var(--color-primary-1)' }}>
      ...
      {/* ALERTS */}
      {error && (
        <div className="alert alert-danger alert-dismissible fade show d-flex align-items-start gap-2" role="alert">
      ...
      <div className="card shadow-sm" style={{ borderRadius: '8px' }}>
        <div className="card-body p-4">
          ...
          <div className="alert alert-info small mb-4">
            <strong>👤 Logged in as:</strong> {user?.firstName} {user?.lastName} (ID: {user?.empId})
            <br />
            <strong>📊 Available Recipients:</strong> {employees.length} employees
            <br />
            <strong>✅ Auto-approval:</strong> Enabled (feedback will be approved immediately)
          </div>
          ...
          <form onSubmit={submitFeedback} noValidate>
            ...
            <div className="row g-3 mb-4">
              ...
              <div className="col-lg-6">
                <label htmlFor="recipientSelect" className="form-label fw-bold mb-2">
                ...
                <div className="position-relative">
                  ...
                  {loadingEmployees && (
                    <Loader 
                      ...
                      style={{ right: '12px', top: '50%', transform: 'translateY(-50%)', animation: 'spin 1s linear infinite' }} 
                    />
                  )}
                </div>
              ...
              {selectedEmployee && (
                <div className="col-lg-6">
                  <label className="form-label fw-bold mb-2">📋 Recipient Details</label>
                  <div
            ...
            {/* FEEDBACK CONTENT */}
            <div className="mb-3">
              <label htmlFor="feedbackContent" className="form-label fw-bold mb-2">
                Feedback Content *
              </label>
              <textarea
                id="feedbackContent"
                ...
                disabled={loading}
                style={{ resize: 'vertical', minHeight: '140px', borderRadius: '8px' }}
              ...
              <div className="d-flex justify-content-between align-items-center mt-2">
                ...
                <small className={isNearLimit ? 'text-danger fw-bold' : 'text-muted'}>
            ...
            <div className="d-grid gap-2 d-sm-flex justify-content-sm-between">
              <button
                ...
                disabled={loading || loadingEmployees || !form.recipientEmployeeId}
