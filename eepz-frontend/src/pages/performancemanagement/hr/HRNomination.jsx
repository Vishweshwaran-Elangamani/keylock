...
function HRNominations() {
  ...
  const fetchStatistics = async () => {
    try {
      ...
      const { data } = await hrNominationApi.getStatistics();
      if (data.success) {
  ...
  const submitAction = async () => {
    ...
    try {
      if (actionType === "approve") {
        ...
        const { data } = await api.rejectNominationsOnly({
          selectedNominationIds: [actionNominationId],
          hrUserId: 1,
      ...
      <div className="container-fluid">
        ...
        <div className="mb-4">
          <h1
            ...
            style={{ color: THEME.primary, marginBottom: "8px" }}
          >
            ...
            <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
              ...
              <div className="btn-group" role="group">
                ...
                <button
                  ...
                  style={{
                    background:
                      viewMode === "grid" ? THEME.primary : THEME.background,
            ...
            >
              <div className="table-responsive">
                <table className="table table-hover mb-0">
                  ...
                  >
                    <tr>
                      <th style={{ fontWeight: "600", color: THEME.primary }}>
                        Nominee
                      </th>
                      <th style={{ fontWeight: "600", color: THEME.primary }}>
                        Department
                        ...
                        >
                          <div className="d-flex gap-2 justify-content-center">
                            <button
                              ...
                              onClick={() =>
                                viewDetails(nomination.nominationId)
                              }
                              title="View Details"
                            >
                              View
                            ...
                            {activeTab === "Pending" && (
                              <>
                                <button
                                  ...
                                  onClick={() =>
                                    openApproveModal(nomination.nominationId)
                                  }
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    openRejectModal(nomination.nominationId)
                                  }
                          ...
                          style={{
                            background:
                              currentPage === pageNum
                                ...
                                : "transparent",
                            color:
                              currentPage === pageNum ? "#fff" : THEME.primary,
                            border: `1px solid ${THEME.border}`,
                          }}
                        >
                          {pageNum}
              ...
              >
                <div className="d-flex gap-2 justify-content-end">
                  ...
                  <button
                    ...
                    style={{
                      background:
                        actionType === "approve" ? THEME.success : THEME.danger,
                      color: "#fff",
                      border: "none",
                      fontWeight: "600",
                      padding: "6px 16px",
