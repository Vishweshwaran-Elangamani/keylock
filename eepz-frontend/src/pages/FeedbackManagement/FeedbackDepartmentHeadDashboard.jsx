...
import {
  RefreshCw, AlertTriangle, FileText, CheckCircle,
  Eye, Users, Clock, BarChart3, UserCheck,
  TrendingUp, Award, ArrowLeft, Inbox
} from 'lucide-react';
...
export default function FeedbackDepartmentHeadDashboard() {
  ...
  const stats = useMemo(() => [
    { label: 'Total Reviews', value: allReviews.length, Icon: FileText, bgColor: '#dbeafe', iconColor: '#0F62FE' },
    { label: 'Pending Reviews', value: pendingReviews.length, Icon: Clock, bgColor: '#fef3c7', iconColor: '#E2B93B' },
    { label: 'Approved Reviews', value: approvedReviews.length, Icon: CheckCircle, bgColor: '#dcfce7', iconColor: '#24A148' },
    { label: 'About Me', value: reviewsAboutMe.length, Icon: UserCheck, bgColor: '#f8f0ff', iconColor: '#9D4EDD' }
      ...
      <div style={{ backgroundColor: '#27235c', borderRadius: '10px 10px 0 0', padding: '0 1rem', marginBottom: 0 }}>
        <ul className="nav nav-tabs border-0 m-0" role="tablist">
          {[
            ...
            { key: 'pending', label: 'Pending Reviews', icon: Clock, count: pendingReviews.length },
            ...
            <li key={key} className="nav-item">
              ...
              >
                <Icon size={16} />
                {label} {count !== undefined && count > 0 && <span>({count})</span>}
              </button>
            </li>
          ))}
        </ul>
            ...
            <div className="row g-3">
              <div className="col-md-4">
                ...
                >
                  ...
                  <span style={{ fontSize: '0.875rem', fontWeight: 600, color: '#0f172a', textAlign: 'center' }}>
                    View All Reviews
                  </span>
              ...
              <div className="col-md-4">
                <Link
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.transform = 'translateY(-2px)';
                    e.currentTarget.style.boxShadow = '0 4px 12px rgba(157, 78, 221, 0.15)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = '#fff';
                    e.currentTarget.style.borderColor = '#e2e8f0';
            ...
            {allReviews.length > 0 && (
              <div className="mt-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h6 className="fw-bold mb-0" style={{ fontSize: '1rem', color: '#0f172a' }}>
                    Recent Reviews
                  </h6>
                  <Link
                    to="/department-head/dashboard/feedback/allreviews"
                      ...
                      <div className="card border-0" style={{ border: '1px solid #e2e8f0', borderRadius: '8px' }}>
                        <div className="card-body" style={{ padding: '1rem' }}>
                          <div className="d-flex justify-content-between align-items-start">
                            <div style={{ flex: 1 }}>
                              <div className="fw-bold" style={{ fontSize: '0.875rem', color: '#0f172a' }}>
                            ...
                            <div className="d-flex flex-column align-items-end gap-2">
                              <span
                                className="badge"
                                style={{
                                  backgroundColor: review.status === 'Approved' ? '#dcfce7' : review.status === 'Pending' ? '#fef3c7' : '#fee2e2',
                                  color: review.status === 'Approved' ? '#24A148' : review.status === 'Pending' ? '#d97706' : '#dc2626',
                                  padding: '4px 10px',
                                  fontSize: '0.75rem',
                                  borderRadius: '6px'
                                }}
          ...
          <div>
            ...
            {pendingReviews.length === 0 ? (
              <div className="text-center py-5">
                <Inbox size={56} style={{ color: '#cbd5e1', opacity: 0.5 }} className="mb-3" />
              ...
              <div className="row g-3">
                {pendingReviews.map((review) => (
                  <div key={review.reviewId} className="col-md-6 col-lg-4">
                    <div className="card border-0 h-100" style={{ border: '1px solid #e2e8f0', borderLeft: '4px solid #E2B93B', borderRadius: '8px' }}>
                      <div className="card-body" style={{ padding: '1rem' }}>
                        <div className="mb-2">
                          <small style={{ fontSize: '0.75rem', color: '#64748b' }}>Employee</small>
                          <h6 className="mb-0" style={{ fontSize: '0.875rem', fontWeight: 600, color: '#0f172a' }}>
                            {review.targetEmployeeName}
                          </h6>
                        </div>
                        <div className="mb-2">
                          <small style={{ fontSize: '0.75rem', color: '#64748b' }}>Reviewed by</small>
                        ...
                        <button
                          ...
                          onClick={() => navigate(`/department-head/dashboard/feedback/review/${review.reviewId}`)}
        ...
        {activeTab === 'submissions' && (
          <div className="text-center py-5">
            ...
            <Link
              ...
              style={{ borderRadius: '8px', fontSize: '0.875rem', padding: '10px 20px' }}
            >
