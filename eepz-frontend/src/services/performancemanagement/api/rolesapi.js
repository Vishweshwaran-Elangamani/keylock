...
export const getApprovedEmployeeDetails = (approvalId) => {
  return apiPort5113.get(
    `/DeptHeadApprovals/approved-employees/${approvalId}/details`
  );
};
...
export const getManagerEmployeeAcknowledgments = () => {
  return apiPort5113.get(
    "/DeptHeadApprovals/manager/employee-acknowledged-comments"
  );
};

export const getAssessmentAttachments = (departmentHeadId, assessmentId) => {
  return apiPort5113.get(
    `/DeptHeadApprovals/${departmentHeadId}/assessment/${assessmentId}/attachments`
  );
};
...
export const getApproverAssessmentAttachments = (userId, assessmentId) => {
  return apiPort5113.get(
    `/approver/${userId}/assessment/${assessmentId}/attachments`
  );
};
...
export const getReviewerSubmittedRatings = (
  userId,
  page = 1,
  pageSize = 25
) => {
...
export const getReviewerAssessmentAttachments = (userId, assessmentId) => {
  return apiPort5113.get(
    `/reviewer/${userId}/assessment/${assessmentId}/attachments`
  );
};
...
export const submitReviewerDecision = (
  userId,
  assessmentId,
  decision,
  note = ""
