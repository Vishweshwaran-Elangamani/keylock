// src/components/sla/ComplianceCard.jsx
import React, { useMemo } from 'react';
import { TrendingUp, AlertCircle, CheckCircle, Clock, Award, Eye, Calendar } from 'lucide-react';
...
const ComplianceCard = ({ compliance, slaData, onClick, showActions = false }) => {
  ...
  const calculatedCompliance = useMemo(() => {
    ...
    return {
      ...
      extendedSlas: slaData.filter(s => s.status === 'Closed' && s.complianceStatus === 'Extended').length,
  ...
  const rating = getComplianceRating(calculatedCompliance.compliancePercentage || 0);
      ...
      <div className="card-body p-4">
          ...
          <div className="flex-grow-1">
            ...
            <div className="d-flex align-items-center gap-2 mt-1">
              <small className="text-muted" style={{ fontSize: '0.75rem' }}>
                ...
                {formatDate(calculatedCompliance.periodStartDate)} - {formatDate(calculatedCompliance.periodEndDate)}
              </small>
            </div>
          </div>
          <div
          ...
          <div className="col-6">
            ...
            >
              ...
              <div className="flex-grow-1">
                ...
                <strong className="d-block" style={{ fontSize: '1rem', color: '#24A148' }}>
                  {onTimeSlas}
                </strong>
              </div>
            </div>
          ...
          <div className="col-6">
            ...
            >
              ...
              <div className="flex-grow-1">
                ...
                <strong className="d-block" style={{ fontSize: '1rem', color: '#E01950' }}>
                  {breachedSlas}
                </strong>
              </div>
            </div>
          ...
          <div className="col-6">
            ...
            >
              ...
              <div className="flex-grow-1">
                ...
                <strong className="d-block" style={{ fontSize: '1rem', color: '#E2B93B' }}>
                  {extendedSlas}
                </strong>
              </div>
            </div>
          ...
          <div className="col-6">
            ...
            >
              ...
              <div className="flex-grow-1">
                ...
                <strong className="d-block" style={{ fontSize: '1rem', color: '#0F62FE' }}>
                  {closedSlas}
                </strong>
              </div>
            </div>
        ...
        {openSlas > 0 && (
          ...
          >
            ...
            <span><strong>{openSlas}</strong> SLA(s) currently open (not included in compliance %)</span>
          </div>
        )}
        ...
        <div className="text-muted small mb-0" style={{ fontSize: '0.75rem' }}>
          ...
          Last Updated: {formatDate(calculatedCompliance.calculatedAt || calculatedCompliance.updatedAt)}
        </div>
      </div>
