        ...
        <div className="col-12 col-xl-11">
          ...
          {moms.length > 0 && (
            <div className="alert alert-info d-flex align-items-center gap-2 mb-4">
              <FileText size={20} />
              <span>You have <strong>{moms.length}</strong> MOM{moms.length !== 1 ? 's' : ''} in total</span>
            </div>
          )}
                          ...
                          <div className="row g-3 mb-3">
                            <div className="col-md-4">
                              <div className="d-flex align-items-start gap-2">
                                <Calendar size={18} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                                <div>
                            ...
                            <div className="col-md-4">
                              <div className="d-flex align-items-start gap-2">
                                <Users size={18} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                                <div>
                                  <div className="text-muted fw-medium" style={{ fontSize: '0.8rem' }}>
                                    Attendees
                                  </div>
                ...
                <div className="modal-content border-0 shadow">
                  <div className="modal-header">
                    <div>
                      ...
                      <p className="text-muted small mb-0">{shareModalMom.meetingTitle}</p>
                    </div>
                  ...
                  <div className="modal-body">
                    ...
                    {selectedEmployees.length > 0 && (
                      <div className="alert alert-info d-flex align-items-center gap-2 mb-3">
                        <Users size={18} />
                        <span><strong>{selectedEmployees.length}</strong> employee(s) selected</span>
                      </div>
                    )}
                  ...
                  <div className="modal-footer">
                    <button className="btn btn-secondary" onClick={closeShareModal}>
                      Cancel
                    </button>
                    <button 
                    ...
                    >
                      <Share2 size={16} />
                      {sharingLoading ? 'Sharing...' : `Share with ${selectedEmployees.length} employee(s)`}
                    </button>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="modal-content border-0 shadow">
                  <div className="modal-header border-0 pb-0">
                    <div className="flex-grow-1">
                      <h5 className="modal-title fw-bold">{selectedMom.meetingTitle}</h5>
                      <p className="text-muted small mb-0">
                        {getMeetingTypeBadge(selectedMom.meetingType)}
                      </p>
                    </div>
                    <button type="button" className="btn-close" onClick={closeMomDetails}></button>
                  </div>
                  ...
                  <div className="modal-body">
                    ...
                    <div className="border-top pt-3">
                      <small className="text-muted">
                        <strong>Created:</strong> {formatDateTime(selectedMom.createdAt)}
                        {selectedMom.updatedAt && (
                          <>
                            {' '} | <strong>Last Updated:</strong> {formatDateTime(selectedMom.updatedAt)}
                          </>
                        )}
                      </small>
                    </div>
                  ...
                  <div className="modal-footer border-0">
                    <button className="btn btn-secondary" onClick={closeMomDetails}>
                      Close
                    </button>
