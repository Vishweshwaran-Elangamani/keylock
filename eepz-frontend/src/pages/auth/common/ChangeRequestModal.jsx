...
const ChangeRequestModal = ({
  ...
  const fetchCurrentEmail = () => {
    ...
    try {
      console.log("1️ Checking profileData prop:", profileData);

      if (profileData?.companyEmail) {
        console.log(
          " Email found in prop (companyEmail):",
      ...
      console.log("2️ Checking localStorage...");
  ...
  const handleCancelRequest = async () => {
    if (
      !window.confirm(
        "Are you sure you want to cancel your pending email change request?"
      )
    ) {
      return;
    }
          ...
          <div className="modal-content-custom">
            ...
            <div className="modal-body-custom">
              <div className="alert-danger-custom">
                ...
                <div>
                  <h6 className="alert-heading-custom">
          ...
          <div className="modal-body-custom">
            <div className="info-alert-custom">
              ...
              <div>
                ...
                address. Your request will be sent to admin for approval. You
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-footer-custom">
                ...
                <button
                  ...
                  className="btn-submit"
                  disabled={
                    !formData.newEmail.trim() || formData.reason.length < 10
                  }
                >
