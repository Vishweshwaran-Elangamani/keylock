            ...
            <div className="fa-content">
              ...
              <div className="fa-section">
                ...
                <div className="fa-feedback-box">
                  <p><strong>Project:</strong> {analysisData.project_name || 'No project title'}</p>
                  <p><strong>Feedback:</strong> {analysisData.input_text}</p>
                </div>
              </div>
              ...
              <div className="fa-metrics-grid">
                ...
                <div className={`fa-metric-card fa-metric-card--${getQualityColorClass(analysisData.overall_quality)}`}>
                  ...
                  <div className="fa-metric-content">
                    ...
                    <div className="fa-metric-value">{analysisData.overall_quality}</div>
                  </div>
                </div>
                ...
                <div className={`fa-metric-card fa-metric-card--${analysisData.fairness_score >= 0.7 ? 'warning' : analysisData.fairness_score >= 0.5 ? 'neutral' : 'danger'}`}>
                  ...
                  <div className="fa-metric-content">
                    ...
                    <div className="fa-metric-value">{(analysisData.fairness_score * 100).toFixed(0)}%</div>
                  </div>
                </div>
                ...
                <div className={`fa-metric-card fa-metric-card--${analysisData.feedback_metrics?.professionalism_score >= 0.7 ? 'success' : 'neutral'}`}>
                  ...
                  <div className="fa-metric-content">
                    ...
                    <div className="fa-metric-value">
                      {analysisData.feedback_metrics ? (analysisData.feedback_metrics.professionalism_score * 100).toFixed(0) : 0}%
                    </div>
                  </div>
                </div>
                ...
                <div className={`fa-metric-card fa-metric-card--${analysisData.constructiveness_analysis?.constructiveness_score >= 0.5 ? 'warning' : 'danger'}`}>
                  ...
                  <div className="fa-metric-content">
                    ...
                    <div className="fa-metric-value">
                      {analysisData.constructiveness_analysis ? (analysisData.constructiveness_analysis.constructiveness_score * 100).toFixed(0) : 0}%
                    </div>
                  </div>
                </div>
              </div>
              ...
              {analysisData.sentiment_analysis && (
                <div className="fa-section">
                  ...
                  <div className={`fa-sentiment-card fa-sentiment-card--${getSentimentColorClass(analysisData.sentiment_analysis.sentiment)}`}>
                    <div className="fa-sentiment-header">
                      <div className="fa-sentiment-result">
                        ➜ {analysisData.sentiment_analysis.sentiment} ({analysisData.sentiment_analysis.sentiment_category})
                      </div>
                      <div className="fa-sentiment-confidence">
                        {(analysisData.sentiment_analysis.confidence * 100).toFixed(0)}% Confidence
                      </div>
                    </div>
                    ...
                    <div className="fa-sentiment-metrics">
                      <div className="fa-sentiment-metric-item">
                        ...
                        <div className="fa-sentiment-metric-value">{analysisData.sentiment_analysis.polarity.toFixed(2)}</div>
                      </div>
                      <div className="fa-sentiment-metric-item">
                        <div className="fa-sentiment-metric-label">Subjectivity</div>
                        <div className="fa-sentiment-metric-value">{analysisData.sentiment_analysis.subjectivity.toFixed(2)}</div>
                      </div>
                      <div className="fa-sentiment-metric-item">
                        <div className="fa-sentiment-metric-label">Intensity</div>
                        <div className="fa-sentiment-metric-value">{analysisData.sentiment_analysis.intensity.toFixed(2)}</div>
                      </div>
                    </div>
                        ...
                        <div className="fa-vader-bar">
                          ...
                          <div className="fa-vader-bar-track">
                            <div 
                              ...
                              style={{ width: `${analysisData.sentiment_analysis.vader_positive * 100}%` }}
                            ></div>
                          </div>
                          <span className="fa-vader-bar-value">{(analysisData.sentiment_analysis.vader_positive * 100).toFixed(1)}%</span>
                        </div>
                        ...
                        <div className="fa-vader-bar">
                          ...
                          <div className="fa-vader-bar-track">
                            <div 
                              ...
                              style={{ width: `${analysisData.sentiment_analysis.vader_neutral * 100}%` }}
                            ></div>
                          </div>
                          <span className="fa-vader-bar-value">{(analysisData.sentiment_analysis.vader_neutral * 100).toFixed(1)}%</span>
                        </div>
                        ...
                        <div className="fa-vader-bar">
                          ...
                          <div className="fa-vader-bar-track">
                            <div 
                              ...
                              style={{ width: `${analysisData.sentiment_analysis.vader_negative * 100}%` }}
                            ></div>
                          </div>
                          <span className="fa-vader-bar-value">{(analysisData.sentiment_analysis.vader_negative * 100).toFixed(1)}%</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="fa-section">
                  ...
                  <div className="fa-emotion-card">
                    <div className="fa-emotion-dominant">
                      <span className="fa-emotion-dominant-label">Dominant Emotion:</span>
                      <span className="fa-emotion-dominant-value">{analysisData.dominant_emotion}</span>
                    </div>
                    ...
                    <div className="fa-emotion-single-bar">
                      <div className="fa-emotion-bar-track">
                        <div 
                          ...
                          style={{ width: `${(analysisData.emotion_scores.neutral || 0) * 100}%` }}
                        ></div>
                      </div>
                      <span className="fa-emotion-bar-value">{((analysisData.emotion_scores.neutral || 0) * 100).toFixed(0)}%</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {analysisData.bias_analysis && (
                <div className="fa-section">
                  ...
                  <div className={`fa-bias-card ${analysisData.bias_analysis.has_bias ? 'fa-bias-card--detected' : 'fa-bias-card--none'}`}>
                    <div className="fa-bias-header">
                      ...
                      <div className="fa-bias-level">Level: {analysisData.bias_analysis.bias_level}</div>
                    </div>
                    <div className="fa-bias-score">Score: {(analysisData.bias_analysis.bias_score * 100).toFixed(0)}%</div>
                  </div>
                </div>
              )}
              ...
              {analysisData.toxicity_analysis && (
                <div className="fa-section">
                  ...
                  <div className={`fa-toxicity-card ${analysisData.toxicity_analysis.is_toxic ? 'fa-toxicity-card--detected' : 'fa-toxicity-card--none'}`}>
                    <div className="fa-toxicity-header">
                      ...
                      <div className="fa-toxicity-severity">Severity: {analysisData.toxicity_analysis.severity}</div>
                    </div>
                  </div>
                </div>
              )}
                  ...
                  <div className="fa-constructiveness-card">
                    <div className="fa-constructiveness-items">
                      <div className="fa-constructiveness-item">
                        {analysisData.constructiveness_analysis.is_constructive ? '○' : '○'} Constructive
                      </div>
                      <div className="fa-constructiveness-item">
                        {analysisData.constructiveness_analysis.is_specific ? '○' : '○'} Specific
                      </div>
                      <div className="fa-constructiveness-item">
                        {analysisData.constructiveness_analysis.is_actionable ? '○' : '○'} Actionable
                      </div>
                      <div className="fa-constructiveness-item">
                        {analysisData.constructiveness_analysis.has_examples ? '○' : '○'} Has Examples
                      </div>
                    </div>
                    <div className="fa-action-items">
                      <strong>Action Items:</strong> {analysisData.constructiveness_analysis.action_items_count}
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="fa-section">
                  ...
                  <div className="fa-feedback-metrics-grid">
                    <div className="fa-feedback-metric-item">
                      ...
                      <div className="fa-feedback-metric-value">{analysisData.feedback_metrics.word_count}</div>
                    </div>
                    <div className="fa-feedback-metric-item">
                      <div className="fa-feedback-metric-label">Sentence Count</div>
                      <div className="fa-feedback-metric-value">{analysisData.feedback_metrics.sentence_count}</div>
                    </div>
                    <div className="fa-feedback-metric-item">
                      <div className="fa-feedback-metric-label">Average Word Length</div>
                      <div className="fa-feedback-metric-value">{analysisData.feedback_metrics.average_word_length.toFixed(2)}</div>
                    </div>
                    <div className="fa-feedback-metric-item">
                      <div className="fa-feedback-metric-label">Complexity Score</div>
                      <div className="fa-feedback-metric-value">{(analysisData.feedback_metrics.complexity_score * 100).toFixed(2)}</div>
                    </div>
                    <div className="fa-feedback-metric-item">
                      <div className="fa-feedback-metric-label">Formality Score</div>
                      <div className="fa-feedback-metric-value">{(analysisData.feedback_metrics.formality_score * 100).toFixed(2)}</div>
                    </div>
                    <div className="fa-feedback-metric-item">
                      <div className="fa-feedback-metric-label">Clarity Score</div>
                      <div className="fa-feedback-metric-value">{(analysisData.feedback_metrics.clarity_score * 100).toFixed(2)}</div>
                    </div>
                    <div className="fa-feedback-metric-item">
                      <div className="fa-feedback-metric-label">Professionalism Score</div>
                      <div className="fa-feedback-metric-value">{(analysisData.feedback_metrics.professionalism_score * 100).toFixed(2)}</div>
                    </div>
                  </div>
                </div>
              )}
                    ...
                    {analysisData.suggestions.improvement_areas && analysisData.suggestions.improvement_areas.length > 0 && (
                      <div className="fa-suggestions-section">
                        ...
                        <div className="fa-focus-tags">
                          {analysisData.suggestions.improvement_areas.map((area, idx) => (
                            <span key={idx} className="fa-focus-tag">{area}</span>
                          ))}
                        </div>
                      </div>
                    )}
