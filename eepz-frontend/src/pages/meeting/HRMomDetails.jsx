    ...
    <div className="container-fluid px-4 py-4" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
      <div className="row justify-content-center">
        <div className="col-12 col-xl-10">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card border-0 shadow-sm">
                <div className="card-body text-center p-3">
                  ...
                  <div className="fw-bold fs-5 mb-1" style={{ color: '#1e293b' }}>
              ...
              <div className="row g-4 mt-2">
                <div className="col-md-6 col-lg-3">
                  <div className="d-flex align-items-start gap-2">
                    <Calendar size={20} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                    <div>
                      <div className="text-muted fw-medium" style={{ fontSize: '0.8rem' }}>
                        Meeting Date & Time
                      </div>
                ...
                {mom.meetingLink && (
                  <div className="col-md-6 col-lg-3">
                    <div className="d-flex align-items-start gap-2">
                      <LinkIcon size={20} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                      <div>
                        <div className="text-muted fw-medium" style={{ fontSize: '0.8rem' }}>
                          Meeting Link
                        </div>
                ...
                <div className="col-md-6 col-lg-3">
                  <div className="d-flex align-items-start gap-2">
                    <User size={20} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                    <div>
                      <div className="text-muted fw-medium" style={{ fontSize: '0.8rem' }}>
                        Submitted By
                      </div>
                      ...
                      {mom.submittedByRole && (
                        <small className="text-muted">{mom.submittedByRole}</small>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-6 col-lg-3">
                  <div className="d-flex align-items-start gap-2">
                    <Clock size={20} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                    <div>
                      <div className="text-muted fw-medium" style={{ fontSize: '0.8rem' }}>
                        Tracking
                      </div>
              ...
              {mom.attendees && Array.isArray(mom.attendees) && mom.attendees.length > 0 ? (
                <div className="row g-3">
                  {mom.attendees.map((attendee, index) => {
                    const attendeeName = typeof attendee === 'string' ? attendee : attendee.name || attendee.employeeName || 'Unknown';
                    return (
                ...
                <div className="alert alert-info mb-0">No attendees recorded</div>
              )}
            </div>
          </div>
          ...
          {mom.commentsObservations && (
            <div className="card border-0 shadow-sm mb-4">
              <div className="card-body p-4">
                ...
                <div className="alert alert-secondary mb-0" style={{ whiteSpace: 'pre-wrap', fontSize: '0.95rem' }}>
                  {mom.commentsObservations}
                </div>
              </div>
            </div>
              ...
              {mom.discussionPoints && Array.isArray(mom.discussionPoints) && mom.discussionPoints.length > 0 ? (
                <div className="d-flex flex-column gap-3">
                  {mom.discussionPoints.map((dp, index) => (
                    <div key={dp.pointId || index} className="card bg-light border-0">
                      <div className="card-body p-4">
                        <div className="d-flex gap-3">
                          <span 
                            className="badge bg-primary rounded-circle d-flex align-items-center justify-content-center"
                            style={{ width: '40px', height: '40px', flexShrink: 0, fontSize: '1rem', fontWeight: '700' }}
                          >
                            {index + 1}
                          </span>
                          <div className="flex-grow-1">
            ...
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <div className="d-flex gap-2">
                  <span className="badge bg-success">{actionStats.completed} Completed</span>
                  <span className="badge bg-warning text-dark">{actionStats.pending} Pending</span>
                  {actionStats.overdue > 0 && (
                    <span className="badge bg-danger">{actionStats.overdue} Overdue</span>
                  )}
                </div>
              </div>
                ...
                <div className="table-responsive">
                  <table className="table table-hover align-middle mb-0">
                    <thead className="table-light">
                      <tr>
                        <th className="fw-semibold" style={{ color: '#64748b', width: '5%' }}>#</th>
                        <th className="fw-semibold" style={{ color: '#64748b', width: '35%' }}>Task Description</th>
                        <th className="fw-semibold" style={{ color: '#64748b', width: '20%' }}>Assigned To</th>
                        <th className="fw-semibold" style={{ color: '#64748b', width: '15%' }}>Due Date</th>
                        <th className="fw-semibold" style={{ color: '#64748b', width: '15%' }}>Status</th>
                        <th className="fw-semibold" style={{ color: '#64748b', width: '10%' }}>Priority</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr key={ai.actionItemId || index}>
                          <td>
                            <div 
                              ...
                              style={{ width: '30px', height: '30px', fontSize: '0.85rem', fontWeight: '600' }}
                            >
                              {index + 1}
                            </div>
                          </td>
                          <td>
                            <div className="d-flex align-items-start gap-2">
                              <CheckCircle size={16} className="text-primary mt-1" style={{ flexShrink: 0 }} />
                              <div>
                                <div className="fw-semibold">{ai.taskDescription || ai.task || 'No description'}</div>
                                {ai.notes && (
                                  <small className="text-muted d-block mt-1">{ai.notes}</small>
                                )}
                              </div>
                            </div>
                          </td>
                          <td>
                            <div className="d-flex align-items-center gap-2">
                              ...
                              <span className="fw-medium">{ai.assignedToEmployeeName || ai.assignTo || 'Unassigned'}</span>
                            </div>
                          </td>
                          <td>
                            <div className="d-flex align-items-center gap-1">
                              <Calendar size={14} className="text-muted" />
                              <span className={ai.isOverdue ? 'text-danger fw-semibold' : 'text-muted'}>
                          ...
                          <td>
                            {ai.priority && (
                              <span className={`badge ${
                                ai.priority === 'High' ? 'bg-danger' :
                                ai.priority === 'Medium' ? 'bg-warning text-dark' :
                                'bg-secondary'
                              }`}>
                                {ai.priority}
                              </span>
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-body p-4">
              <h6 className="fw-semibold mb-4">System Information & Metadata</h6>
              <div className="row g-4">
                <div className="col-md-3">
                  <small className="text-muted d-block mb-2">MOM ID</small>
                  <span className="fw-semibold font-monospace">{mom.momId}</span>
                </div>
                <div className="col-md-3">
                  <small className="text-muted d-block mb-2">Created At</small>
                  <span className="fw-semibold">{formatDateTime(mom.createdAt)}</span>
                </div>
                {mom.updatedAt && (
                  <div className="col-md-3">
                    <small className="text-muted d-block mb-2">Last Updated</small>
                    <span className="fw-semibold">{formatDateTime(mom.updatedAt)}</span>
                  </div>
                )}
                {mom.submittedById && (
                  <div className="col-md-3">
                    <small className="text-muted d-block mb-2">Submitted By ID</small>
                    <span className="fw-semibold font-monospace">{mom.submittedById}</span>
                  </div>
                )}
                {mom.departmentId && (
                  <div className="col-md-3">
                    <small className="text-muted d-block mb-2">Department ID</small>
                    <span className="fw-semibold font-monospace">{mom.departmentId}</span>
                  </div>
                )}
                {mom.projectId && (
                  <div className="col-md-3">
                    <small className="text-muted d-block mb-2">Project ID</small>
                    <span className="fw-semibold font-monospace">{mom.projectId}</span>
                  </div>
                )}
                <div className="col-md-3">
                ...
                <div className="col-md-3">
                  ...
                  <span className="badge bg-info text-dark">{mom.isPrivate ? 'Private' : 'Public'}</span>
                </div>
              </div>
            </div>
          </div>
