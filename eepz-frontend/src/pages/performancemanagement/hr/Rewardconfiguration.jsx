...
function RewardConfiguration() {
  ...
  const handleToggleActive = async (rewardType) => {
    try {
      ...
      const { data } = await api.updateRewardType(
      ...
      if (data.success) {
        alert(
          `Reward type ${
            !rewardType.isActive ? "activated" : "deactivated"
          } successfully!`
        );
        fetchRewardTypes();
  ...
  const handleCreateRewardType = async (e) => {
    ...
    try {
      ...
      alert(
        `Error ${isEditMode ? "updating" : "creating"} reward type: ` +
  ...
  const RewardTypeCard = ({ rewardType }) => (
    <div
      ...
      style={{
        ...
        borderRadius: "8px",
        background:
          selectedRewardType?.rewardTypeId === rewardType.rewardTypeId
            ? "#f0f9ff"
            : "#fff",
        borderColor:
          selectedRewardType?.rewardTypeId === rewardType.rewardTypeId
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                padding: "10px 16px",
                background:
                  activeTab === "Inactive" ? "#27235C" : "transparent",
            ...
            {loading ? (
              ...
              >
                <div
                  ...
                  role="status"
                  style={{ color: "#27235C", width: "32px", height: "32px" }}
                >
              ...
              >
                <div>
                  ...
                  <p style={{ fontSize: "14px", color: "#6b7280", margin: 0 }}>
                    {selectedRewardType.description ||
