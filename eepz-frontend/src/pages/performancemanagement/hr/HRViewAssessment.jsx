    ...
    <>
      ...
      {modalRow && (
        <div className="eepz-modal-bg" onClick={() => setModalRow(null)}>
          <div
            className="eepz-modal-content"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              className="eepz-modal-close"
              ...
              {modalRow.competencies.map((c, idx) => (
                <React.Fragment key={idx}>
                  <div className="eepz-modal-field">
                    ...
                    <span className="eepz-modal-valueview">
                      {c.competencyName}
                    </span>
                  </div>
                  <div className="eepz-modal-field">
                    <span className="eepz-modal-icon bi bi-graph-up"></span>
                    <span className="eepz-modal-labelview">
                      Employee Rating
                    </span>
                    <span className="eepz-modal-valueview">
                      {c.employeeRating ?? "-"}
                  ...
                  {idx < modalRow.competencies.length - 1 && (
                    <hr className="eepz-modal-divider" />
                  )}
                </React.Fragment>
              ))}
            </div>
