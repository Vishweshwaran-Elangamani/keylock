    ...
    public class ManagerNominationService : IManagerNominationService
    {
        ...
        public async Task<object> GetOpportunitiesByRewardTypeAsync(int rewardTypeId)
        {
            try
            {
                ...
                {
                    return new { success = false, message = "Reward type not available for manager nominations" };
                }
        ...
        public async Task<object> SubmitNominationAsync(NominationSubmitDto dto)
        {
            try
            {
                ...
                if (!isL1Manager)
                {
                    ...
                    return new { success = false, statusCode = 403, message = "Only L1 managers can submit nominations" };
                }
                ...
                if (!nomineeInManagerProjects)
                {
                    ...
                    return new { success = false, statusCode = 403, message = "You can only nominate employees from projects where you are L1 manager" };
                }
        ...
        public async Task<object> GetEmployeeNominationsAsync(int employeeId)
        {
            try
            {
                ...
                var result = nominations.Select(n => new
                {
                    n.NominationId,
                    n.Status,
                    n.SubmittedAt,
                ...
                foreach (var n in nominations)
                {
                    ...
                    result.Add(new
                    {
                        ...
                        Nominee = new
                        {
                            ...
                            Department = dept?.Department != null ? new
                            {
