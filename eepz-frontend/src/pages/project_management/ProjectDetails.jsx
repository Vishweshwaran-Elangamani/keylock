...
const ProjectDetails = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    const config = statusConfig[status] || { color: 'secondary', icon: Activity };
    const Icon = config.icon;
    return (
      <span className={`badge bg-${config.color} d-flex align-items-center gap-2`}>
        <Icon size={16} />
        {status}
      </span>
    );
      ...
      <div className="d-flex align-items-center justify-content-between mb-4">
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted mb-0 small">Complete project information and team details</p>
          </div>
        </div>
      </div>
                  ...
                  <div className="col-md-6">
                    <div className="d-flex align-items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mb-0 fw-semibold">{formatDate(project.startDate)}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="d-flex align-items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mb-0 fw-semibold">{formatDate(project.endDate)}</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="col-lg-4">
            ...
            <div className="card border-0 shadow-sm sticky-top" style={{ top: '20px' }}>
              ...
              <div className="card-body">
                {/* Resource Owner */}
                <div className="mb-4">
                  <label className="text-muted small mb-2 d-block">Resource Owner</label>
                  {project.resourceOwner ? (
                    <div className="border rounded p-3">
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                          <h6 className="mb-0">{project.resourceOwner.firstName} {project.resourceOwner.lastName}</h6>
                          <p className="mb-0 small text-muted">{project.resourceOwner.roleName}</p>
                          <p className="mb-0 small text-muted">{project.resourceOwner.departmentName}</p>
                        </div>
                      </div>
                    </div>
                  ) : (
                  ...
                  {project.l1Approver ? (
                    <div className="border rounded p-3">
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                          <h6 className="mb-0">{project.l1Approver.firstName} {project.l1Approver.lastName}</h6>
                          <p className="mb-0 small text-muted">{project.l1Approver.roleName}</p>
                          <p className="mb-0 small text-muted">{project.l1Approver.departmentName}</p>
                        </div>
                      </div>
                    </div>
                  ) : (
                  ...
                  {project.l2Approver ? (
                    <div className="border rounded p-3">
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                          <h6 className="mb-0">{project.l2Approver.firstName} {project.l2Approver.lastName}</h6>
                          <p className="mb-0 small text-muted">{project.l2Approver.roleName}</p>
                          <p className="mb-0 small text-muted">{project.l2Approver.departmentName}</p>
                        </div>
                      </div>
                    </div>
                  ) : (
