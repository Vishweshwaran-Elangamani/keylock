...
const HRMomDashboard = () => {
  ...
  const getThisMonthCount = () => {
    ...
    return moms.filter(m => {
      try {
        ...
        return momDate.getMonth() === today.getMonth() && momDate.getFullYear() === today.getFullYear();
      } catch {
        return false;
      }
    }).length;
  ...
  const getTotalDiscussionPoints = () => {
    if (!Array.isArray(moms)) return 0;
    return moms.reduce((sum, mom) => {
      return sum + (Array.isArray(mom.discussionPoints) ? mom.discussionPoints.length : 0);
    }, 0);
  };
    ...
    <div className="container-fluid px-4 py-4" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
      <div className="row justify-content-center">
        <div className="col-12">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card border-0 shadow-sm">
                <div className="card-body p-4">
                  ...
                  <div className="fw-bold fs-3 mb-1" style={{ color: '#1e293b' }}>
                    {totalMoms}
                  </div>
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    <div 
                      className="rounded d-flex align-items-center justify-content-center"
                      style={{ width: '50px', height: '50px', backgroundColor: '#e8f5e9' }}
                    >
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    <div 
                      className="rounded d-flex align-items-center justify-content-center"
                      style={{ width: '50px', height: '50px', backgroundColor: '#e1f5fe' }}
                    >
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    <div 
                      className="rounded d-flex align-items-center justify-content-center"
                      style={{ width: '50px', height: '50px', backgroundColor: '#f3e5f5' }}
                    >
                  ...
                  <small className="text-muted fw-medium">Discussion Points</small>
                </div>
              </div>
            </div>
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body p-4">
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    <div 
                      className="rounded d-flex align-items-center justify-content-center"
                      style={{ width: '50px', height: '50px', backgroundColor: '#ffebee' }}
                    >
            ...
            <div className="card-body p-4">
              ...
              {showFilters && (
                <div className="row g-3">
                  ...
                  <div className="col-md-6 col-lg-2">
                    <label className="form-label fw-semibold small">Per Page</label>
                    <select
                      name="pageSize"
                      className="form-select"
              ...
              <div className="table-responsive">
                <table className="table table-hover align-middle mb-0">
                  <thead style={{ backgroundColor: '#f8f9fa' }}>
                    <tr>
                      <th className="fw-semibold ps-4 py-3" style={{ color: '#64748b', textTransform: 'uppercase', fontSize: '0.75rem', letterSpacing: '0.5px' }}>
                        MEETING DETAILS
                      </th>
                      <th className="fw-semibold py-3" style={{ color: '#64748b', textTransform: 'uppercase', fontSize: '0.75rem', letterSpacing: '0.5px' }}>
                        SUBMITTED BY
                      </th>
                      <th className="fw-semibold py-3" style={{ color: '#64748b', textTransform: 'uppercase', fontSize: '0.75rem', letterSpacing: '0.5px' }}>
                        MEETING DATE
                      </th>
                      <th className="fw-semibold text-center py-3" style={{ color: '#64748b', textTransform: 'uppercase', fontSize: '0.75rem', letterSpacing: '0.5px' }}>
                        PARTICIPANTS
                      </th>
                      <th className="fw-semibold text-center py-3" style={{ color: '#64748b', textTransform: 'uppercase', fontSize: '0.75rem', letterSpacing: '0.5px' }}>
                        TOPICS
                      ...
                      <th className="fw-semibold pe-4 py-3" style={{ color: '#64748b', textTransform: 'uppercase', fontSize: '0.75rem', letterSpacing: '0.5px' }}>
                        VIEW
                      </th>
                    </tr>
                  </thead>
                    ...
                    {loading ? (
                      <tr>
                        <td colSpan="7" className="text-center py-5">
                          ...
                          <p className="text-muted mt-3 mb-0">Loading MOMs...</p>
                        </td>
                      </tr>
                    ) : !Array.isArray(moms) || moms.length === 0 ? (
                      <tr>
                        <td colSpan="7" className="text-center py-5">
                          <FileText size={48} className="mb-3 text-muted" style={{ opacity: 0.3 }} />
                          <h6 className="text-muted mb-2">No MOMs Found</h6>
                          <p className="text-muted small mb-0">
                            {filters.searchTerm || filters.meetingType || filters.startDate || filters.endDate
                        ...
                        <tr key={mom.momId}>
                          ...
                          <td className="py-3">
                            <div className="d-flex align-items-center gap-2">
                              <div 
                                ...
                                style={{ width: '32px', height: '32px', backgroundColor: '#f1f5f9', flexShrink: 0 }}
                              >
                                <User size={16} style={{ color: '#64748b' }} />
                              </div>
                              <div>
                                <div className="fw-medium small" style={{ color: '#1e293b' }}>
                          ...
                          <td className="py-3">
                            <div className="d-flex align-items-center gap-2">
                              ...
                              <span className="text-muted small">{formatDateTime(mom.meetingDate)}</span>
                            </div>
                          </td>
                          <td className="text-center py-3">
                            <div className="d-inline-flex align-items-center gap-2 px-3 py-2 rounded" style={{ backgroundColor: '#f1f5f9' }}>
                          ...
                          <td className="text-center py-3">
                            <div className="d-inline-flex align-items-center gap-2 px-3 py-2 rounded" style={{ backgroundColor: '#f1f5f9' }}>
                              ...
                              <span className="fw-semibold" style={{ color: '#1e293b' }}>
                                {Array.isArray(mom.actionItems) ? mom.actionItems.length : 0}
                              </span>
                            </div>
                          </td>
                          <td className="pe-4 py-3">
                            <button
                              ...
                              style={{ backgroundColor: '#4f46e5', color: 'white', borderRadius: '6px' }}
          ...
          {!loading && Array.isArray(moms) && moms.length > 0 && totalPages > 1 && (
            <div className="card border-0 shadow-sm">
              <div className="card-body p-3">
                <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                  <div className="text-muted small">
                    Showing {((filters.pageNumber - 1) * filters.pageSize) + 1} to {Math.min(filters.pageNumber * filters.pageSize, totalMoms)} of {totalMoms} MOMs
                  </div>
                  <nav>
                    <ul className="pagination mb-0">
                      <li className={`page-item ${filters.pageNumber <= 1 ? 'disabled' : ''}`}>
                        <button
                      ...
                      {[...Array(Math.min(5, totalPages))].map((_, idx) => {
                        ...
                        return (
                          <li key={pageNum} className={`page-item ${filters.pageNumber === pageNum ? 'active' : ''}`}>
                            <button
                              className="page-link"
                      ...
                      <li className={`page-item ${filters.pageNumber >= totalPages ? 'disabled' : ''}`}>
                        <button
                          className="page-link d-flex align-items-center gap-1"
                          onClick={() => handlePageChange(filters.pageNumber + 1)}
