...
import { RefreshCw, AlertTriangle, ArrowLeft, Users, User, Calendar, MessageCircle } from 'lucide-react';
      ...
      <div style={{ width: '100%', maxWidth: '1000px', paddingLeft: '1rem', paddingRight: '1rem' }}>
        ...
        <div className="d-flex align-items-center justify-content-between mb-4">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <h2 className="fw-bold mb-1" style={{ color: 'var(--color-primary-1)' }}>Peer Feedback</h2>
              ...
              <div className="card border-0" style={{ border: '1px solid var(--border)', borderRadius: 'var(--radius-md)' }}>
                <div className="card-body">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      <h5 className="fw-bold mb-0" style={{ color: '#0F62FE' }}>{peerFeedback.length}</h5>
                      <small className="text-muted">Peer Feedback Received</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-12" key={feedback.queueId}>
                <div className="card border-0" style={{ border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow)' }}>
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between align-items-start mb-3">
                      <div>
                        <div className="d-flex align-items-center gap-2 mb-2">
                          ...
                          <h6 className="fw-bold mb-0">{feedback.submittedByName}</h6>
                        </div>
                        <div className="d-flex align-items-center gap-2">
                      ...
                      <div className="d-flex flex-column align-items-end gap-2">
                        <span className="badge" style={{ 
                          backgroundColor: feedback.status === 'Approved' ? '#24A14820' : '#0F62FE20', 
                          color: feedback.status === 'Approved' ? '#24A148' : '#0F62FE',
                          padding: '6px 12px'
                        }}>
                    ...
                    <div className="mb-3">
                      <div className="d-flex align-items-center gap-2 mb-2">
                        <MessageCircle size={16} style={{ color: 'var(--color-primary-1)' }} />
                        <h6 className="small fw-bold text-muted mb-0">Feedback</h6>
                      </div>
                      <p className="mb-0" style={{ lineHeight: '1.6', color: '#333', marginLeft: '2rem' }}>
                    ...
                    {(feedback.context || feedback.feedbackContext) && (
                      <div className="p-3 rounded" style={{ backgroundColor: '#f9f9f9', borderLeft: '3px solid var(--color-primary-1)' }}>
                        <h6 className="small fw-bold text-muted mb-1">Context</h6>
