...
const MOCK_EMPLOYEES = [
  { empId: 1004, firstName: 'Dave', lastName: 'Dev', employeeCode: 'EMP-1004', role: 'Employee', department: 'Engineering' },
  { empId: 1005, firstName: 'Frank', lastName: 'Frontend', employeeCode: 'EMP-1005', role: 'Employee', department: 'Engineering' },
  { empId: 1006, firstName: 'Jane', lastName: 'Design', employeeCode: 'EMP-1006', role: 'Employee', department: 'Design' },
  { empId: 1003, firstName: 'Carol', lastName: 'Code', employeeCode: 'EMP-1003', role: 'Employee', department: 'Engineering' }
];
              ...
              {employees.map(emp => (
                <div className="col-md-6 col-lg-4" key={emp.empId}>
                  <div className="card h-100 border-0" style={{ border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)' }}>
                    <div className="card-body">
                      <h6 className="mb-1">{emp.firstName} {emp.lastName}</h6>
                      <p className="small text-muted mb-2">{emp.employeeCode}</p>
