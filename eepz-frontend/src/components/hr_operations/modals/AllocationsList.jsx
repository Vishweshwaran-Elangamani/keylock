    ...
    <div className="allocations-root">
      ...
      <div className="allocations-filter-section">
        <div className="allocations-filter-row">
          <div className="allocations-search-wrapper">
            <i className="bi bi-search allocations-search-icon"></i>
            <input
              type="text"
              name="search"
              ...
              className="allocations-filter-search"
            />
          </div>
          ...
          <select
            ...
            className="allocations-filter-select"
          >
