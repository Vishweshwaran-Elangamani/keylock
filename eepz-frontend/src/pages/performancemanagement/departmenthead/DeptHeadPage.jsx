    ...
    <div className="dp-page">
      ...
      <div className="dp-page-header">
        <div className="dp-header-content">
         ...
         {/* Stats Cards */}
      {/* Stats Cards - Modern analytics style */}
<div className="fld-analytics-cards" style={{ marginBottom: "1.5rem", display: "flex", gap: "1rem", flexWrap: "wrap", }}>
  <div className="fld-analytics-card" style={{
    background: "#fff",
    color: "#27235c",
    flex: "1 1 150px",
    minWidth: "140px",
  ...
  <div className="fld-analytics-card" style={{
    ...
    <div>
      ...
      <h4 style={{
        ...
        fontSize: "1.11rem",
        marginBottom: "0.45rem"
      }}>Approved Employees</h4>
      <p style={{
        fontSize: "1.83rem",
        fontWeight: 800,
        margin: 0,
        color: "#97247e"
      }}>{approvedRequests.length}</p>
    </div>
  </div>
</div>
