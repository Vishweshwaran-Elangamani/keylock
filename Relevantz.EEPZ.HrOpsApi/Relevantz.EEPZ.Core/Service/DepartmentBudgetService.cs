...
namespace Relevantz.EEPZ.Core.Service
{
    public class DepartmentBudgetService : IDepartmentBudgetService
    {
        ...
        public async Task<ApiResponseDto<List<object>>> GetAllDepartmentBudgetsAsync()
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error fetching all department budgets", ex);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<object>> GetDepartmentBudgetAsync(int departmentId)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error fetching budget for department {DepartmentId}", ex, departmentId);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<List<object>>> GetDepartmentBudgetsByYearAsync(int fiscalYear)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error fetching budgets for fiscal year {FiscalYear}", ex, fiscalYear);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<object>> CreateDepartmentBudgetAsync(CreateDepartmentBudgetDto request)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error creating budget for department {DepartmentId}", ex, request.DepartmentId);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<object>> UpdateDepartmentBudgetAsync(UpdateDepartmentBudgetDto request)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error updating budget {BudgetId}", ex, request.BudgetId);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<object>> DeleteDepartmentBudgetAsync(int budgetId)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error deleting budget {BudgetId}", ex, budgetId);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<object>> UpdateUtilizedAmountAsync(UpdateUtilizedAmountDto request)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error updating utilized amount for budget {BudgetId}", ex, request.BudgetId);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<object>> UpdateUtilizationAsync(UpdateUtilizationDto request)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error updating utilization for allocation {AllocationId}", ex, request.AllocationId);
                throw;
            }
        }
        ...
        public async Task<ApiResponseDto<List<object>>> GetAllocationsByBudgetAsync(int budgetId)
        {
            ...
            {
                EEPZBusinessLog.LogServiceError("Error fetching allocations for budget {BudgetId}", ex, budgetId);
                throw;
            }
        }
