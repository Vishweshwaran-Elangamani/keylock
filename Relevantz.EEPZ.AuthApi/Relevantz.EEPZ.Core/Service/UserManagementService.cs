...
//                 // if (request.ConfirmationDate.HasValue) employee.ConfirmationDate = request.ConfirmationDate;
//                 // if (request.ExitDate.HasValue) employee.ExitDate = request.ExitDate;
