...
const DeptHeadReviewModal = ({
  ...
  const showToast = (title, message, type) => {
    const toastElement = document.getElementById("deptHeadReviewToast");
    if (!toastElement) return;

    const toastTitle = document.getElementById("deptHeadReviewToastTitle");
    const toastBody = document.getElementById("deptHeadReviewToastBody");
      ...
      <div className="career-progression-toast-container">
        ...
        >
          <div className="toast-header">
            <strong className="me-auto" id="deptHeadReviewToastTitle">
              Notification
            </strong>
            <button
              type="button"
          ...
          <div className="toast-body" id="deptHeadReviewToastBody">
            Toast message here
          </div>
        </div>
      </div>
