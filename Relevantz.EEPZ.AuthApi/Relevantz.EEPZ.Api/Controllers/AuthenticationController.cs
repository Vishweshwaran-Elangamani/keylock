...
namespace Relevantz.EEPZ.Api.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequestDto request)
        {
            ...
            if (!result.Success)
            {
                _logger.LogWarning("Login failed for {MaskedEmail}. Reason: {Reason}", maskedEmail, result.Message);
                return Unauthorized(result);
            }

            _logger.LogInformation("Login successful for {MaskedEmail}. OTP sent.", maskedEmail);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> VerifyOtp([FromBody] VerifyOtpRequestDto request)
        {
            ...
            if (!result.Success)
            {
                _logger.LogWarning("OTP verification failed for {MaskedEmail}. Reason: {Reason}", maskedEmail, result.Message);
        ...
        public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordRequestDto request)
        {
            ...
            {
                _logger.LogWarning("Password reset request failed for {MaskedEmail}. Reason: {Reason}", maskedEmail, result.Message);
            }
        ...
        public async Task<IActionResult> ResetPassword([FromBody] ResetPasswordRequestDto request)
        {
            ...
            if (!result.Success)
            {
                _logger.LogWarning("Password reset failed for {MaskedEmail}. Reason: {Reason}", maskedEmail, result.Message);
                return BadRequest(result);
            }
        ...
        public async Task<IActionResult> ChangePassword([FromBody] ChangePasswordRequestDto request)
        {
            ...
            if (!result.Success)
            {
                _logger.LogWarning("Change password failed for UserId: {UserId}. Reason: {Reason}", userId, result.Message);
                return BadRequest(result);
            }
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            {
                _logger.LogWarning("Logout failed for UserId: {UserId}. Reason: {Reason}", userId, result.Message);
            }
