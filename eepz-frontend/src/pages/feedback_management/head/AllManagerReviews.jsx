    ...
    <div className="container-fluid py-3" style={{ maxWidth: '1400px' }}>
      ...
      <div className="d-flex justify-content-between align-items-start mb-4">
        <div className="d-flex gap-2 align-items-start">
          ...
          <div>
            <h2 className="fw-bold mb-1" style={{ color: 'var(--color-primary-1)' }}>All Manager Reviews</h2>
            <p className="mb-0 small text-muted">View all review comments and feedback given by managers</p>
          </div>
        </div>
        <button
