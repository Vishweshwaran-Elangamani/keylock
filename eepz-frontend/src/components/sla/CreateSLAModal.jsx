// src/components/sla/CreateSLAModal.jsx - REVIEW TYPE TEXT INPUT
    ...
    try {
      ...
      res.data.forEach(item => {
        if (item.employeeId && !uniqueEmployees.has(item.employeeId)) {
          uniqueEmployees.set(item.employeeId, { id: item.employeeId, name: item.employeeName });
        }
      });
        ...
        <div style={{ padding: '2rem' }}>
          {fetchLoading ? (
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '200px' }}>
              <Loader size={32} style={{ color: '#0F62FE', marginBottom: '1rem', animation: 'spin 1s linear infinite' }} />
            ...
            <form onSubmit={handleSubmit}>
              {/* ERROR */}
              {error && (
                <div style={{ display: 'flex', gap: '1rem', padding: '1rem', backgroundColor: '#fde7e7', border: '1px solid #e01950', borderRadius: '8px', marginBottom: '1.5rem' }}>
                  <AlertCircle size={20} style={{ color: '#e01950', flexShrink: 0 }} />
              ...
              >
                <p style={{ margin: 0, color: '#0F62FE', fontWeight: '600', fontSize: '1.25rem' }}>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: 'none',
              borderRadius: '8px',
              cursor: (loading || fetchLoading || employeeCount === 0) ? 'not-allowed' : 'pointer',
              fontSize: '0.875rem',
              fontWeight: '500',
              display: 'flex',
              alignItems: 'center',
