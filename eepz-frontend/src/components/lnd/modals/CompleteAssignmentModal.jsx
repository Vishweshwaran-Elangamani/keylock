...
const CompleteAssignmentModal = ({ assignment, onClose, onSuccess }) => {
  ...
  const ratingColorClass = rating < RATING.MIN_REQUEST_SME 
    ? styles.ratingBtnLow 
          ...
          <form onSubmit={handleSubmit}>
            <div className={styles.body}>
              ...
              <div className={styles.alert}>
                <CheckCircle size={20} color="#198754" className={styles.alertIcon} />
                <div>
              ...
              {assignment.completionNotes && (
                <div className={styles.smeNotesContainer}>
                  <label className={styles.smeNotesLabel}>
                    SME's Notes
                  </label>
              ...
              <div>
                <label className={styles.ratingLabel}>
                  New Skill Rating <span className={styles.required}> *</span>:{" "}
                  <span 
                  ...
                  {[...Array(10)].map((_, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`${styles.ratingBtn} ${rating === value ? ratingColorClass : ''}`}
                      >
                        {value}
                      </button>
                    );
