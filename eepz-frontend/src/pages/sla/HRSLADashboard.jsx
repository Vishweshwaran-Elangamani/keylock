    ...
    <div className="container-fluid" style={{ padding: '1.5rem 1.5rem' }}>
      ...
      <div className="row g-3 mb-4">
        {[
          ...
          { label: 'On Time', value: stats.onTime, icon: TrendingUp, bgColor: '#d1fae5', iconColor: '#059669' },
          { label: 'Extended', value: stats.extended, icon: AlertTriangle, bgColor: '#fef3c7', iconColor: '#E2B93B' },
          { label: 'Breached', value: stats.breached, icon: AlertTriangle, bgColor: '#fee2e2', iconColor: '#E01950'}
                ...
                {currentSLAs.length === 0 ? (
                  <tr>
                    ...
                    >
                      <FileText
                        ...
                        style={{ opacity: 0.2 }}
                      />
                      <p className="text-muted mb-2 fw-semibold" style={{ fontSize: '1rem' }}>
                  ...
                  currentSLAs.map(sla => (
                    ...
                    >
                      ...
                      <td style={{ padding: '1rem 1.25rem', verticalAlign: 'middle' }}>
                        {sla.assignedToName ? (
                          <small style={{ fontSize: '0.875rem', color: '#475569', fontWeight: 500 }}>
                            {sla.assignedToName}
                          </small>
                        ) : (
                          <small
