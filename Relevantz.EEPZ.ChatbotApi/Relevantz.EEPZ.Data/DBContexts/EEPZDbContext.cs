...
public partial class EEPZDbContext : DbContext
{
    ...
    public virtual DbSet<Chatactionlog> Chatactionlogs { get; set; }

    public virtual DbSet<Chatconversation> Chatconversations { get; set; }

    public virtual DbSet<Chatmessage> Chatmessages { get; set; }

    public virtual DbSet<Chatpattern> Chatpatterns { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        optionsBuilder.UseMySql(
            "server=mysql;database=eepzdb;uid=root;pwd=root",
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            ...
            entity.Property(e => e.Country).HasMaxLength(100).HasDefaultValueSql("'India'");
            entity
        ...
        modelBuilder.Entity<Assessmentform>(entity =>
        {
            ...
            entity
                .Property(e => e.DeliveryEnablement)
        ...
        modelBuilder.Entity<Assessmentreview>(entity =>
        {
            ...
            entity.Property(e => e.Comments).HasColumnType("text").HasColumnName("comments");
            entity.Property(e => e.DetailId).HasColumnName("detail_id");
        ...
        modelBuilder.Entity<Assignment>(entity =>
        {
            ...
            entity
                .HasOne(d => d.AssignedByNavigation)
            ...
            entity
                .HasOne(d => d.Employee)
                .WithMany(p => p.AssignmentEmployees)
                .HasForeignKey(d => d.EmployeeId)
        ...
        modelBuilder.Entity<Budgetallocation>(entity =>
        {
            ...
            entity.Property(e => e.Period).HasMaxLength(10).HasComment("Q1, Q2, Q3, Q4");
            entity
                .Property(e => e.UpdatedAt)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");
            entity
                .Property(e => e.UtilizationPercentage)
                .HasPrecision(5, 2)
                .HasDefaultValueSql("'0.00'");
            entity.Property(e => e.UtilizedAmount).HasPrecision(15, 2).HasDefaultValueSql("'0.00'");

            entity
                .HasOne(d => d.AllocatedByUser)
                .WithMany(p => p.BudgetallocationAllocatedByUsers)
            ...
            entity
                .HasOne(d => d.EmployeeUser)
                .WithMany(p => p.BudgetallocationEmployeeUsers)
        ...
        modelBuilder.Entity<Budgetperiodallocation>(entity =>
        {
            ...
            entity
                ...
                .HasColumnType("datetime");
            entity.Property(e => e.Notes).HasMaxLength(500);
            entity.Property(e => e.Period).HasMaxLength(10).HasComment("Q1, Q2, Q3, Q4, H1, H2");
            entity
                .Property(e => e.UpdatedAt)
                .ValueGeneratedOnAddOrUpdate()
                .HasColumnType("datetime");
            ...
            entity
                .HasOne(d => d.AllocatedByUser)
                .WithMany(p => p.Budgetperiodallocations)
                .HasForeignKey(d => d.AllocatedByUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Bulkoperationlog>(entity =>
        {
            ...
            entity
                .Property(e => e.PerformedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");

            entity
                .HasOne(d => d.PerformedByUser)
                .WithMany(p => p.Bulkoperationlogs)
        ...
        modelBuilder.Entity<Chatactionlog>(entity =>
        {
            entity.HasKey(e => e.ActionLogId).HasName("PRIMARY");

            entity.ToTable("chatactionlogs");
            ...
            entity.HasIndex(e => e.ExecutedAt, "idx_executed_at");
        ...
        modelBuilder.Entity<Chatmessage>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsUserMessage, "idx_is_user_message");
        ...
        modelBuilder.Entity<Chatpattern>(entity =>
        {
            entity.HasKey(e => e.PatternId).HasName("PRIMARY");

            entity.ToTable("chatpatterns");
            ...
            entity
                .HasIndex(e => e.Pattern, "idx_pattern")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 255 });

            entity.HasIndex(e => e.Priority, "idx_priority").IsDescending();
        ...
        modelBuilder.Entity<Departmentbudget>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.DepartmentId, e.FiscalYear }, "idx_department_year")
                .IsUnique();

            entity
                .Property(e => e.AllocatedAmount)
                .HasPrecision(15, 2)
                .HasDefaultValueSql("'0.00'");
            entity
                .Property(e => e.AvgCostPerEmployee)
                .HasPrecision(15, 2)
                .HasComputedColumnSql(
                    "case when (`Headcount` > 0) then (`UtilizedAmount` / `Headcount`) else 0 end",
                    true
                );
            entity
                .Property(e => e.CreatedAt)
            ...
            entity
                .HasOne(d => d.Department)
                .WithMany(p => p.Departmentbudgets)
                .HasForeignKey(d => d.DepartmentId)
        ...
        modelBuilder.Entity<Departmentheadapproval>(entity =>
        {
            ...
            entity
                .Property(e => e.ApprovedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");
            entity.Property(e => e.EmployeeComments).HasColumnType("text");
            entity.Property(e => e.Status).HasMaxLength(20).HasDefaultValueSql("'Approved'");

            entity
                .HasOne(d => d.ApprovedByNavigation)
                .WithMany(p => p.Departmentheadapprovals)
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity
                .HasOne(d => d.ReportingManagerEmployee)
                .WithMany(p => p.InverseReportingManagerEmployee)
        ...
        modelBuilder.Entity<Employeedetailsmaster>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Department)
                .WithMany(p => p.Employeedetailsmasters)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Engagement>(entity =>
        {
            ...
            entity.Property(e => e.TrendScore).HasPrecision(5, 2).HasColumnName("trend_score");
        ...
        modelBuilder.Entity<Feedback>(entity =>
        {
            ...
            entity
                ...
                .HasColumnType(
                    "enum('GoalBased','ProjectBased','PeerFeedback','MentorFeedback','HRForm','OrganizationalGoal','BiasReview')"
                );
            entity
                .Property(e => e.HrreviewComments)
                .HasColumnType("text")
            ...
            entity
                .HasOne(d => d.RecipientEmployee)
                .WithMany(p => p.FeedbackRecipientEmployees)
                .HasForeignKey(d => d.RecipientEmployeeId)
                .HasConstraintName("FK_Feedback_Recipient");

            entity
                .HasOne(d => d.RelatedGoal)
            ...
            entity
                .HasOne(d => d.RelatedMentor)
                .WithMany(p => p.FeedbackRelatedMentors)
                .HasForeignKey(d => d.RelatedMentorId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_Feedback_Mentor");

            entity
                .HasOne(d => d.RelatedProject)
                .WithMany(p => p.Feedbacks)
            ...
            entity
                .HasOne(d => d.SubmittedByEmployee)
                .WithMany(p => p.FeedbackSubmittedByEmployees)
        ...
        modelBuilder.Entity<Feedbackedithistory>(entity =>
        {
            ...
            entity
                .HasOne(d => d.EditedByEmployee)
                .WithMany(p => p.Feedbackedithistories)
        ...
        modelBuilder.Entity<Feedbackquestionresponse>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.FeedbackId, e.QuestionId }, "uniq_feedback_question")
                .IsUnique();
            ...
            entity
                .HasOne(d => d.Feedback)
                .WithMany(p => p.Feedbackquestionresponses)
                .HasForeignKey(d => d.FeedbackId)
        ...
        modelBuilder.Entity<Formprogresstracker>(entity =>
        {
            ...
            entity.Property(e => e.AssignmentId).HasColumnName("assignment_id");
            entity
                .Property(e => e.EmployeeCompleted)
                .HasDefaultValueSql("'0'")
                .HasColumnName("employee_completed");
            entity.Property(e => e.Initiated).HasDefaultValueSql("'0'").HasColumnName("initiated");
            entity
        ...
        modelBuilder.Entity<Goal>(entity =>
        {
            ...
            entity.Property(e => e.ClosedOn).HasColumnType("timestamp").HasColumnName("closed_on");
            entity
                .Property(e => e.ClosureReason)
                .HasColumnType("text")
            ...
            entity.Property(e => e.GoalTitle).HasMaxLength(200).HasColumnName("goal_title");
            entity.Property(e => e.GoalType).HasMaxLength(100).HasColumnName("goal_type");
            entity
                .Property(e => e.Goalcreatedat)
                .HasColumnType("datetime")
                .HasColumnName("goalcreatedat");
            entity.Property(e => e.Goalendat).HasColumnType("datetime").HasColumnName("goalendat");
            entity
                .Property(e => e.Goalstatus)
                .HasColumnType(
                    "enum('pending','open','inprogress','completed','closed','expired','reopened')"
                )
                .HasColumnName("goalstatus");
            entity.Property(e => e.ProjectId).HasColumnName("project_id");
            entity
                .Property(e => e.ReopenUntil)
                .HasColumnType("timestamp")
                .HasColumnName("reopen_until");
            entity.Property(e => e.ReopenedBy).HasColumnName("reopened_by");
            entity
                .Property(e => e.ReopenedOn)
                .HasColumnType("timestamp")
                .HasColumnName("reopened_on");

            entity
                .HasOne(d => d.ClosedByNavigation)
                .WithMany(p => p.GoalClosedByNavigations)
            ...
            entity
                .HasOne(d => d.CreatedByNavigation)
                .WithMany(p => p.GoalCreatedByNavigations)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.SetNull)
            ...
            entity
                .HasOne(d => d.ReopenedByNavigation)
                .WithMany(p => p.GoalReopenedByNavigations)
        ...
        modelBuilder.Entity<GoalApproval>(entity =>
        {
            ...
            entity
                .Property(e => e.ApprovalType)
                .HasColumnType(
                    "enum('creation','completion','reopening','delegation','selfgoalactivation','task_acknowledgment','closure','reactivation')"
                )
            ...
            entity
                .HasOne(d => d.ApprovedByNavigation)
                .WithMany(p => p.GoalApprovalApprovedByNavigations)
                .HasForeignKey(d => d.ApprovedBy)
                .OnDelete(DeleteBehavior.SetNull)
            ...
            entity
                .HasOne(d => d.Goal)
                .WithMany(p => p.GoalApprovals)
                .HasForeignKey(d => d.GoalId)
                .HasConstraintName("goal_approvals_ibfk_1");

            entity
                .HasOne(d => d.RequestedByNavigation)
                .WithMany(p => p.GoalApprovalRequestedByNavigations)
        ...
        modelBuilder.Entity<GoalAssignment>(entity =>
        {
            ...
            entity.Property(e => e.GoalId).HasColumnName("goal_id");
            entity
                .Property(e => e.IsAcknowledged)
                .HasDefaultValueSql("'0'")
                .HasColumnName("is_acknowledged");

            entity
                .HasOne(d => d.AcknowledgedByNavigation)
                .WithMany(p => p.GoalAssignmentAcknowledgedByNavigations)
            ...
            entity
                .HasOne(d => d.AssignedByNavigation)
                .WithMany(p => p.GoalAssignmentAssignedByNavigations)
                .HasForeignKey(d => d.AssignedBy)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("goal_assignment_ibfk_2");

            entity
                .HasOne(d => d.AssignedToNavigation)
                .WithMany(p => p.GoalAssignmentAssignedToNavigations)
        ...
        modelBuilder.Entity<GoalAttachment>(entity =>
        {
            ...
            entity
                .Property(e => e.AttachedOn)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("timestamp")
                .HasColumnName("attached_on");
            entity
                .Property(e => e.AttachmentTitle)
                .HasMaxLength(200)
                .HasColumnName("attachment_title");
            entity.Property(e => e.Attachments).HasMaxLength(500).HasColumnName("attachments");
            entity.Property(e => e.GoalId).HasColumnName("goal_id");
            entity
                .Property(e => e.IsProofOfCompletion)
                .HasDefaultValueSql("'0'")
                .HasColumnName("is_proof_of_completion");
            entity.Property(e => e.LinkedApprovalId).HasColumnName("linked_approval_id");

            entity
                .HasOne(d => d.AttachedByNavigation)
                .WithMany(p => p.GoalAttachments)
        ...
        modelBuilder.Entity<GoalChecklist>(entity =>
        {
            ...
            entity.Property(e => e.GoalId).HasColumnName("goal_id");
            entity.Property(e => e.IsShared).HasDefaultValueSql("'0'").HasColumnName("is_shared");
            entity
                .Property(e => e.ItemDescription)
                .HasColumnType("text")
                .HasColumnName("item_description");
            entity.Property(e => e.ItemTitle).HasMaxLength(200).HasColumnName("item_title");

            entity
                .HasOne(d => d.AddedByNavigation)
                .WithMany(p => p.GoalChecklistAddedByNavigations)
                .HasForeignKey(d => d.AddedBy)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("goal_checklist_ibfk_2");

            entity
                .HasOne(d => d.AddedForNavigation)
                .WithMany(p => p.GoalChecklistAddedForNavigations)
        ...
        modelBuilder.Entity<GoalComment>(entity =>
        {
            ...
            entity
                .Property(e => e.CommentedOn)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("timestamp")
                .HasColumnName("commented_on");
            entity
                .Property(e => e.GoalComment1)
                .HasColumnType("text")
                .HasColumnName("goal_comment");
            entity.Property(e => e.GoalId).HasColumnName("goal_id");

            entity
                .HasOne(d => d.CommentedByNavigation)
                .WithMany(p => p.GoalComments)
        ...
        modelBuilder.Entity<Goalchecklistprogress>(entity =>
        {
            ...
            entity
                ...
                .WithMany(p => p.Goalchecklistprogresses)
        ...
        modelBuilder.Entity<Hrfeedbackform>(entity =>
        {
            ...
            entity
                ...
                .HasColumnType(
                    "enum('GeneralFeedback','BiasReview','ProfessionalismReview','PerformanceReview')"
                );
            entity
                .Property(e => e.Status)
                .HasDefaultValueSql("'Draft'")
            ...
            entity
                .HasOne(d => d.CreatedByHr)
                .WithMany(p => p.Hrfeedbackforms)
        ...
        modelBuilder.Entity<Hrfeedbackformresponse>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Form)
                .WithMany(p => p.Hrfeedbackformresponses)
                .HasForeignKey(d => d.FormId)
        ...
        modelBuilder.Entity<Internalopportunity>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Department)
                .WithMany(p => p.Internalopportunities)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Leadershipauditlog>(entity =>
        {
            ...
            entity.Property(e => e.TargetTable).HasMaxLength(100).HasColumnName("target_table");
            entity
                .Property(e => e.Timestamp)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime")
            ...
            entity
                .HasOne(d => d.User)
                .WithMany(p => p.Leadershipauditlogs)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.SetNull)
        ...
        modelBuilder.Entity<Lndapproval>(entity =>
        {
            ...
            entity.ToTable("lndapprovals").UseCollation("utf8mb4_0900_ai_ci");
            ...
            entity.Property(e => e.Notes).HasMaxLength(500);
            entity.Property(e => e.Status).HasMaxLength(50).HasDefaultValueSql("'PENDING'");

            entity
                .HasOne(d => d.ApproverEmployee)
                .WithMany(p => p.LndapprovalApproverEmployees)
            ...
            entity
                ...
                .WithMany(p => p.LndapprovalRequesterEmployees)
        ...
        modelBuilder.Entity<Lndassignment>(entity =>
        {
            ...
            entity.ToTable("lndassignments").UseCollation("utf8mb4_0900_ai_ci");
            ...
            entity.HasIndex(
                e => new { e.MenteeEmployeeId, e.Status },
                "IX_LnDAssignments_Mentee_Status"
            );
            ...
            entity.Property(e => e.Status).HasMaxLength(50).HasDefaultValueSql("'IN_PROGRESS'");

            entity
                .HasOne(d => d.CreatedByEmployee)
                .WithMany(p => p.LndassignmentCreatedByEmployees)
                .HasForeignKey(d => d.CreatedByEmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LnDAssignments_CreatedBy");

            entity
                .HasOne(d => d.MenteeEmployee)
                .WithMany(p => p.LndassignmentMenteeEmployees)
                .HasForeignKey(d => d.MenteeEmployeeId)
                .HasConstraintName("FK_LnDAssignments_Mentee");

            entity
                .HasOne(d => d.Skill)
                .WithMany(p => p.Lndassignments)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity
                ...
                .WithMany(p => p.LndassignmentUpdatedByEmployees)
        ...
        modelBuilder.Entity<Lndattachment>(entity =>
        {
            ...
            entity.ToTable("lndattachments").UseCollation("utf8mb4_0900_ai_ci");

            entity.HasIndex(
                e => new { e.CreatedByEmployeeId, e.AttachmentType },
                "IX_LnDAttachments_CreatedBy_Type"
            );
        ...
        modelBuilder.Entity<Lndemployeeskillmapper>(entity =>
        {
            ...
            entity.ToTable("lndemployeeskillmapper").UseCollation("utf8mb4_0900_ai_ci");
            ...
            entity.HasIndex(
                e => new { e.EmployeeId, e.Rating },
                "IX_EmployeeSkillMapper_Rating_Employee"
            );
            ...
            entity
                .HasOne(d => d.CreatedByEmployee)
                .WithMany(p => p.LndemployeeskillmapperCreatedByEmployees)
                .HasForeignKey(d => d.CreatedByEmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity
                .HasOne(d => d.Employee)
                .WithMany(p => p.LndemployeeskillmapperEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .HasConstraintName("FK_EmployeeSkillMapper_Employee");

            entity
                .HasOne(d => d.Skill)
                .WithMany(p => p.Lndemployeeskillmappers)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity
                .HasOne(d => d.UpdatedByEmployee)
                .WithMany(p => p.LndemployeeskillmapperUpdatedByEmployees)
                .HasForeignKey(d => d.UpdatedByEmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Lndsme>(entity =>
        {
            ...
            entity.ToTable("lndsme").UseCollation("utf8mb4_0900_ai_ci");
            ...
            entity.HasIndex(
                e => new { e.SkillId, e.ApprovedByEmployeeId },
                "IX_SME_Skill_Approved"
            );
            ...
            entity
                ...
                .WithMany(p => p.LndsmeApprovedByEmployees)
        ...
        modelBuilder.Entity<Managernominationtracking>(entity =>
        {
            ...
            entity
                .Property(e => e.ViewedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");

            entity
                .HasOne(d => d.Nomination)
                .WithMany(p => p.Managernominationtrackings)
                .HasForeignKey(d => d.NominationId)
                .HasConstraintName("managernominationtracking_ibfk_1");

            entity
                .HasOne(d => d.ViewedByUser)
                .WithMany(p => p.Managernominationtrackings)
        ...
        modelBuilder.Entity<Managerreviewcomment>(entity =>
        {
            ...
            entity
                ...
                .WithMany(p => p.ManagerreviewcommentManagerEmployees)
                .HasForeignKey(d => d.ManagerEmployeeId)
                .HasConstraintName("FK_ManagerReview_Manager");

            entity
                .HasOne(d => d.TargetEmployee)
                .WithMany(p => p.ManagerreviewcommentTargetEmployees)
                .HasForeignKey(d => d.TargetEmployeeId)
                .HasConstraintName("FK_ManagerReview_Target");

            entity
                .HasOne(d => d.TargetGoal)
                .WithMany(p => p.Managerreviewcomments)
        ...
        modelBuilder.Entity<MasterSkill>(entity =>
        {
            ...
            entity.ToTable("master_skill").UseCollation("utf8mb4_0900_ai_ci");
        ...
        modelBuilder.Entity<Meeting>(entity =>
        {
            ...
            entity
                .HasOne(d => d.ScheduledByEmployee)
        ...
        modelBuilder.Entity<Meetingparticipant>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.MeetingId, e.EmployeeId }, "unique_meeting_participant")
                .IsUnique();
        ...
        modelBuilder.Entity<Mentorfeedbacktracking>(entity =>
        {
            ...
            entity
                .HasOne(d => d.MenteeEmployee)
                .WithMany(p => p.MentorfeedbacktrackingMenteeEmployees)
                .HasForeignKey(d => d.MenteeEmployeeId)
                .HasConstraintName("FK_MentorFeedback_Mentee");

            entity
                .HasOne(d => d.MentorEmployee)
                .WithMany(p => p.MentorfeedbacktrackingMentorEmployees)
                .HasForeignKey(d => d.MentorEmployeeId)
                .HasConstraintName("FK_MentorFeedback_Mentor");

            entity
                .HasOne(d => d.ReviewedByHr)
                .WithMany(p => p.Mentorfeedbacktrackings)
                .HasForeignKey(d => d.ReviewedByHrid)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_MentorFeedback_ReviewedBy");

            entity
                .HasOne(d => d.SkillIdReferenceNavigation)
                .WithMany(p => p.Mentorfeedbacktrackings)
            ...
            entity
                .HasOne(d => d.SubmittedByEmployee)
                .WithMany(p => p.MentorfeedbacktrackingSubmittedByEmployees)
                .HasForeignKey(d => d.SubmittedByEmployeeId)
        ...
        modelBuilder.Entity<Mom>(entity =>
        {
            ...
            entity
                ...
                .HasColumnType("text");
            entity
                .Property(e => e.CommentsObservations)
        ...
        modelBuilder.Entity<Momactionitem>(entity =>
        {
            ...
            entity
                .Property(e => e.AssignedToEmployeeId)
            ...
            entity
                .HasOne(d => d.AssignedToEmployee)
                .WithMany(p => p.Momactionitems)
        ...
        modelBuilder.Entity<Momsharing>(entity =>
        {
            ...
            entity.HasIndex(
                e => new { e.SharedWithEmployeeId, e.SharedAt },
                "idx_shared_with_date"
            );

            entity.Property(e => e.Momid).HasColumnName("MOMId");
            entity
                .Property(e => e.SharedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");
            entity.Property(e => e.SharedByEmployeeId).HasComment("Employee who shared the MOM");
            entity
                .Property(e => e.SharedWithEmployeeId)
                .HasComment("Employee who received the shared MOM");

            entity
                .HasOne(d => d.Mom)
                .WithMany(p => p.Momsharings)
                .HasForeignKey(d => d.Momid)
                .HasConstraintName("momsharing_ibfk_1");

            entity
                .HasOne(d => d.SharedByEmployee)
                .WithMany(p => p.MomsharingSharedByEmployees)
                .HasForeignKey(d => d.SharedByEmployeeId)
                .HasConstraintName("momsharing_ibfk_2");

            entity
                .HasOne(d => d.SharedWithEmployee)
                .WithMany(p => p.MomsharingSharedWithEmployees)
        ...
        modelBuilder.Entity<Nomination>(entity =>
        {
            ...
            entity
                .Property(e => e.L1reviewRemarks)
                .HasMaxLength(500)
                .HasColumnName("L1ReviewRemarks");
            entity
                .Property(e => e.L1reviewedAt)
                .HasColumnType("datetime")
                .HasColumnName("L1ReviewedAt");
            entity.Property(e => e.L1status).HasMaxLength(20).HasColumnName("L1Status");
            entity.Property(e => e.L2managerUserId).HasColumnName("L2ManagerUserId");
            entity
                .Property(e => e.L2reviewRemarks)
                .HasMaxLength(500)
                .HasColumnName("L2ReviewRemarks");
            entity
                .Property(e => e.L2reviewedAt)
                .HasColumnType("datetime")
                .HasColumnName("L2ReviewedAt");
            entity.Property(e => e.L2status).HasMaxLength(20).HasColumnName("L2Status");
            ...
            entity
                ...
                .WithMany(p => p.NominationReviewedByUsers)
        ...
        modelBuilder.Entity<Nominationparameter>(entity =>
        {
            ...
            entity
                .HasOne(d => d.RewardType)
                .WithMany(p => p.Nominationparameters)
        ...
        modelBuilder.Entity<Nominationparametervalue>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.NominationId, e.ParameterId }, "unique_nomination_parameter")
                .IsUnique();
            ...
            entity
                .HasOne(d => d.Nomination)
                .WithMany(p => p.Nominationparametervalues)
                .HasForeignKey(d => d.NominationId)
                .HasConstraintName("nominationparametervalues_ibfk_1");

            entity
                .HasOne(d => d.Parameter)
                .WithMany(p => p.Nominationparametervalues)
        ...
        modelBuilder.Entity<Nominationreviewmetric>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Nomination)
                .WithMany(p => p.Nominationreviewmetrics)
                .HasForeignKey(d => d.NominationId)
        ...
        modelBuilder.Entity<Nominationvisibilitytracking>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Nomination)
                .WithMany(p => p.Nominationvisibilitytrackings)
                .HasForeignKey(d => d.NominationId)
                .HasConstraintName("nominationvisibilitytracking_ibfk_1");

            entity
                .HasOne(d => d.ViewedByEmployee)
                .WithMany(p => p.Nominationvisibilitytrackings)
        ...
        modelBuilder.Entity<Oneononediscussion>(entity =>
        {
            ...
            entity
                ...
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");
            entity.Property(e => e.IsPrivate).IsRequired().HasDefaultValueSql("'1'");
            ...
            entity
                .HasOne(d => d.CreatedByNavigation)
                .WithMany(p => p.OneononediscussionCreatedByNavigations)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity
                ...
                .WithMany(p => p.OneononediscussionHostEmployees)
                .HasForeignKey(d => d.HostEmployeeId)
                .HasConstraintName("oneononediscussion_ibfk_1");

            entity
                .HasOne(d => d.ParticipantEmployee)
                .WithMany(p => p.OneononediscussionParticipantEmployees)
        ...
        modelBuilder.Entity<Organizationalpolicy>(entity =>
        {
            ...
            entity
                .HasOne(d => d.CreatedByUser)
                .WithMany(p => p.OrganizationalpolicyCreatedByUsers)
                .HasForeignKey(d => d.CreatedByUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("organizationalpolicies_ibfk_1");

            entity
                .HasOne(d => d.PublishedByNavigation)
                .WithMany(p => p.OrganizationalpolicyPublishedByNavigations)
        ...
        modelBuilder.Entity<Organizationgoalfeedback>(entity =>
        {
            ...
            entity
                .HasOne(d => d.ManagerEmployee)
                .WithMany(p => p.OrganizationgoalfeedbackManagerEmployees)
                .HasForeignKey(d => d.ManagerEmployeeId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_OrgGoalFeedback_Manager");

            entity
                .HasOne(d => d.OrganizationObjective)
                .WithMany(p => p.Organizationgoalfeedbacks)
                .HasForeignKey(d => d.OrganizationObjectiveId)
                .HasConstraintName("FK_OrgGoalFeedback_Objective");

            entity
                .HasOne(d => d.SubmittedByEmployee)
                .WithMany(p => p.OrganizationgoalfeedbackSubmittedByEmployees)
                .HasForeignKey(d => d.SubmittedByEmployeeId)
        ...
        modelBuilder.Entity<Organizationwideobjective>(entity =>
        {
            ...
            entity.Property(e => e.Description).HasColumnType("text").HasColumnName("description");
            entity
                .Property(e => e.TimelineEnd)
                .HasColumnType("datetime")
                .HasColumnName("timeline_end");
            entity
                .Property(e => e.TimelineStart)
                .HasColumnType("datetime")
            ...
            entity
                .HasOne(d => d.CreatedByNavigation)
                .WithMany(p => p.Organizationwideobjectives)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.SetNull)
        ...
        modelBuilder.Entity<Payroll>(entity =>
        {
            ...
            entity
                ...
                .WithMany(p => p.PayrollApprovedByUsers)
            ...
            entity
                .HasOne(d => d.EmployeeUser)
                .WithMany(p => p.PayrollEmployeeUsers)
                .HasForeignKey(d => d.EmployeeUserId)
        ...
        modelBuilder.Entity<Peerfeedback>(entity =>
        {
            ...
            entity
                .HasOne(d => d.PeerEmployee)
                .WithMany(p => p.PeerfeedbackPeerEmployees)
            ...
            entity
                .HasOne(d => d.SubmittedByEmployee)
                .WithMany(p => p.PeerfeedbackSubmittedByEmployees)
                .HasForeignKey(d => d.SubmittedByEmployeeId)
                .OnDelete(DeleteBehavior.SetNull)
        ...
        modelBuilder.Entity<Peerfeedbackqueue>(entity =>
        {
            ...
            entity
                .HasOne(d => d.ApprovedByHr)
                .WithMany(p => p.Peerfeedbackqueues)
            ...
            entity
                .HasOne(d => d.RecipientEmployee)
                .WithMany(p => p.PeerfeedbackqueueRecipientEmployees)
                .HasForeignKey(d => d.RecipientEmployeeId)
                .HasConstraintName("FK_PeerQueue_Recipient");

            entity
                .HasOne(d => d.SubmittedByEmployee)
                .WithMany(p => p.PeerfeedbackqueueSubmittedByEmployees)
                .HasForeignKey(d => d.SubmittedByEmployeeId)
        ...
        modelBuilder.Entity<Policyviolation>(entity =>
        {
            ...
            entity
                .HasOne(d => d.EmployeeUser)
                .WithMany(p => p.PolicyviolationEmployeeUsers)
                .HasForeignKey(d => d.EmployeeUserId)
                .HasConstraintName("policyviolations_ibfk_1");

            entity
                .HasOne(d => d.EscalatedToUser)
                .WithMany(p => p.PolicyviolationEscalatedToUsers)
            ...
            entity
                ...
                .WithMany(p => p.PolicyviolationReportedByUsers)
        ...
        modelBuilder.Entity<Profilechangerequest>(entity =>
        {
            ...
            entity
                .HasOne(d => d.ApprovedByUser)
                .WithMany(p => p.ProfilechangerequestApprovedByUsers)
                .HasForeignKey(d => d.ApprovedByUserId)
                .OnDelete(DeleteBehavior.SetNull)
            ...
            entity
                .HasOne(d => d.User)
                .WithMany(p => p.ProfilechangerequestUsers)
                .HasForeignKey(d => d.UserId)
        ...
        modelBuilder.Entity<Project>(entity =>
        {
            ...
            entity.Property(e => e.IsDeletable).IsRequired().HasDefaultValueSql("'1'");
            ...
            entity.Property(e => e.Status).HasMaxLength(50).HasDefaultValueSql("'Active'");
            entity
                .Property(e => e.UpdatedAt)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
            ...
            entity
                .HasOne(d => d.L1approverEmployee)
                .WithMany(p => p.ProjectL1approverEmployees)
                .HasForeignKey(d => d.L1approverEmployeeId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_ibfk_2");

            entity
                .HasOne(d => d.L2approverEmployee)
                .WithMany(p => p.ProjectL2approverEmployees)
                .HasForeignKey(d => d.L2approverEmployeeId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("project_ibfk_3");

            entity
                .HasOne(d => d.ResourceOwnerEmployee)
                .WithMany(p => p.ProjectResourceOwnerEmployees)
        ...
        modelBuilder.Entity<Projectemployee>(entity =>
        {
            ...
            entity.HasIndex(
                e => new { e.ProjectId, e.IsPrimary },
                "idx_projectemployees_isPrimary"
            );
        ...
        modelBuilder.Entity<Projectgoalfeedback>(entity =>
        {
            ...
            entity.HasIndex(
                e => new { e.ProjectId, e.GoalId },
                "IX_ProjectGoalFeedback_ProjectGoal"
            );
            ...
            entity
                .HasIndex(e => e.SubmittedAt, "IX_ProjectGoalFeedback_SubmittedAt")
                .IsDescending();
            ...
            entity
                ...
                .WithMany(p => p.Projectgoalfeedbacks)
        ...
        modelBuilder.Entity<Promotion>(entity =>
        {
            ...
            entity
                .HasOne(d => d.ApprovedByUser)
                .WithMany(p => p.PromotionApprovedByUsers)
                .HasForeignKey(d => d.ApprovedByUserId)
                .OnDelete(DeleteBehavior.SetNull)
            ...
            entity
                .HasOne(d => d.EmployeeUser)
                .WithMany(p => p.PromotionEmployeeUsers)
                .HasForeignKey(d => d.EmployeeUserId)
        ...
        modelBuilder.Entity<Recognitiondetail>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Department)
                .WithMany(p => p.Recognitiondetails)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Recognitionreward>(entity =>
        {
            ...
            entity.Property(e => e.AmountGrade).HasMaxLength(100).HasColumnName("amount_grade");
            entity.Property(e => e.EmployeeId).HasColumnName("employee_id");
            entity.Property(e => e.Reason).HasColumnType("text").HasColumnName("reason");
            entity
                .Property(e => e.RewardDate)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime")
            ...
            entity
                .HasOne(d => d.Employee)
                .WithMany(p => p.RecognitionrewardEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .HasConstraintName("recognitionrewards_ibfk_1");

            entity
                .HasOne(d => d.SubmittedByNavigation)
                .WithMany(p => p.RecognitionrewardSubmittedByNavigations)
        ...
        modelBuilder.Entity<Recognitionstatus>(entity =>
        {
            ...
            entity
                .HasOne(d => d.NominatedByEmployee)
                .WithMany(p => p.RecognitionstatusNominatedByEmployees)
                .HasForeignKey(d => d.NominatedByEmployeeId)
                .HasConstraintName("recognitionstatus_ibfk_3");

            entity
                .HasOne(d => d.NomineeEmployee)
                .WithMany(p => p.RecognitionstatusNomineeEmployees)
                .HasForeignKey(d => d.NomineeEmployeeId)
                .HasConstraintName("recognitionstatus_ibfk_2");

            entity
                .HasOne(d => d.Opportunity)
                .WithMany(p => p.Recognitionstatuses)
                .HasForeignKey(d => d.OpportunityId)
                .HasConstraintName("recognitionstatus_ibfk_1");

            entity
                .HasOne(d => d.ReviewedByEmployee)
                .WithMany(p => p.RecognitionstatusReviewedByEmployees)
        ...
        modelBuilder.Entity<Report>(entity =>
        {
            ...
            entity.Property(e => e.ExcelPath).HasMaxLength(500).HasColumnName("excel_path");
            entity.Property(e => e.GeneratedBy).HasColumnName("generated_by");
            entity.Property(e => e.PdfPath).HasMaxLength(500).HasColumnName("pdf_path");
            entity
            ...
            entity
                .HasOne(d => d.GeneratedByNavigation)
        ...
        modelBuilder.Entity<Risk>(entity =>
        {
            ...
            entity
                ...
                .HasColumnType("datetime")
                .HasColumnName("period_start");
            entity.Property(e => e.RiskType).HasMaxLength(100).HasColumnName("risk_type");
            entity.Property(e => e.TrendGraph).HasColumnType("text").HasColumnName("trend_graph");
        ...
        modelBuilder.Entity<Selfassessmentattachment>(entity =>
        {
            ...
            entity.Property(e => e.FilePath).HasMaxLength(1000).HasColumnName("file_path");
            ...
            entity
                .HasOne(d => d.Assessment)
                .WithMany(p => p.Selfassessmentattachments)
                .HasForeignKey(d => d.AssessmentId)
        ...
        modelBuilder.Entity<Sla>(entity =>
        {
            ...
            entity.Property(e => e.Slatype).HasMaxLength(100).HasColumnName("SLAType");
            entity
                .Property(e => e.Status)
            ...
            entity
                .HasOne(d => d.AssignedToEmployee)
                .WithMany(p => p.SlaAssignedToEmployees)
                .HasForeignKey(d => d.AssignedToEmployeeId)
            ...
            entity
                .HasOne(d => d.Employee)
                .WithMany(p => p.SlaEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_sla_employee");

            entity
                .HasOne(d => d.ReopenedByEmployee)
                .WithMany(p => p.SlaReopenedByEmployees)
        ...
        modelBuilder.Entity<Slacompliance>(entity =>
        {
            ...
            entity
                .Property(e => e.CompliancePercentage)
                .HasPrecision(5, 2)
                .HasComputedColumnSql(
                    "case when (`TotalSLAs` > 0) then round(((`OnTimeSLAs` / `TotalSLAs`) * 100),2) else 0 end",
                    true
                );
            entity
                .Property(e => e.CreatedAt)
            ...
            entity
                .HasOne(d => d.CalculatedByNavigation)
                .WithMany(p => p.Slacompliances)
        ...
        modelBuilder.Entity<Slaescalation>(entity =>
        {
            ...
            entity.HasIndex(
                e => e.EscalatedToEmployeeId,
                "idx_slaescalation_EscalatedToEmployeeId"
            );
            ...
            entity.HasIndex(
                e => e.SubmittedByEmployeeId,
                "idx_slaescalation_SubmittedByEmployeeId"
            );

            entity.Property(e => e.Description).HasMaxLength(500);
            entity.Property(e => e.EscalationDeadline).HasColumnType("datetime");
            entity
                .Property(e => e.EscalationLevel)
                .HasColumnType("enum('L1','L2','DeptHead','Leadership')");
            entity
                .Property(e => e.EscalationStatus)
            ...
            entity
                .HasOne(d => d.EscalatedToEmployee)
                .WithMany(p => p.SlaescalationEscalatedToEmployees)
                .HasForeignKey(d => d.EscalatedToEmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_slaescalation_escalated_to");

            entity
                .HasOne(d => d.ResolvedByEmployee)
                .WithMany(p => p.SlaescalationResolvedByEmployees)
            ...
            entity
                .HasOne(d => d.SubmittedByEmployee)
                .WithMany(p => p.SlaescalationSubmittedByEmployees)
                .HasForeignKey(d => d.SubmittedByEmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Slahistory>(entity =>
        {
            ...
            entity
                .HasOne(d => d.ChangedByEmployee)
                .WithMany(p => p.Slahistories)
                .HasForeignKey(d => d.ChangedByEmployeeId)
                .HasConstraintName("fk_slahistory_changed_by");

            entity
                .HasOne(d => d.ReferenceEscalation)
                .WithMany(p => p.Slahistories)
        ...
        modelBuilder.Entity<Slareviewtracking>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Employee)
                .WithMany(p => p.SlareviewtrackingEmployees)
                .HasForeignKey(d => d.EmployeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity
                .HasOne(d => d.Form)
                .WithMany(p => p.Slareviewtrackings)
                .HasForeignKey(d => d.FormId)
                .HasConstraintName("fk_slareviewtracking_form");

            entity
                .HasOne(d => d.Reviewer)
                .WithMany(p => p.SlareviewtrackingReviewers)
                .HasForeignKey(d => d.ReviewerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Userauthentication>(entity =>
        {
            ...
            entity
                .HasOne(d => d.Employee)
                .WithOne(p => p.Userauthentication)
