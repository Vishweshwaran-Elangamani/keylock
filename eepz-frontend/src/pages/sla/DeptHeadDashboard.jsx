...
const DeptHeadSLADashboard = () => {
  ...
  const calculateStats = () => {
    return {
      ...
      pending: filteredL2Escalations.filter(e => e.escalationStatus === 'Pending').length,
      resolved: filteredL2Escalations.filter(e => e.escalationStatus === 'Resolved').length,
      ...
      <div className="row g-3 mb-4">
          ...
          <div className="card border-0 shadow-sm h-100" style={{ borderRadius: '12px' }}>
            <div className="card-body">
              <div className="rounded-circle d-flex align-items-center justify-content-center mb-3"
                   style={{ width: '48px', height: '48px', backgroundColor: '#0F62FE15' }}>
                <Users size={24} color="#0F62FE" />
              </div>
              <h3 className="fw-bold mb-1">{stats.total}</h3>
              <p className="text-muted mb-0">L2 Escalations ({selectedPeriod})</p>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-3">
          <div className="card border-0 shadow-sm h-100" style={{ borderRadius: '12px' }}>
            <div className="card-body">
              <div className="rounded-circle d-flex align-items-center justify-content-center mb-3"
                   style={{ width: '48px', height: '48px', backgroundColor: '#E2B93B15' }}>
        ...
        <div className="col-md-3">
          <div className="card border-0 shadow-sm h-100" style={{ borderRadius: '12px' }}>
            <div className="card-body">
              <div className="rounded-circle d-flex align-items-center justify-content-center mb-3"
                   style={{ width: '48px', height: '48px', backgroundColor: '#24A14815' }}>
        ...
        <div className="col-md-3">
          <div className="card border-0 shadow-sm h-100" style={{ borderRadius: '12px' }}>
            <div className="card-body">
              ...
              <h3 className="fw-bold mb-1" style={{ color: getComplianceColor(stats.compliance) }}>
          ...
          <div className="card-body">
            ...
            {filteredL2Escalations.length === 0 ? (
              <div className="text-center py-5">
                ...
                <p className="text-muted mb-0">No manager escalations pending for {selectedPeriod}</p>
              </div>
            ) : (
                  ...
                  <tbody>
                    {filteredL2Escalations.map(esc => (
                      <tr key={esc.escalationId}>
                        <td className="px-4">
                          <strong>{esc.employeeName}</strong><br/>
                          <small className="text-muted">{esc.employeeEmail || 'N/A'}</small>
                        </td>
                        <td>
                        ...
                        <td>
                          ...
                          <small className="text-muted">{esc.description || 'No details'}</small>
                        </td>
                        <td>
                          <span className={`badge ${
                            esc.escalationStatus === 'Pending' ? 'bg-warning text-dark' :
                            'bg-success'
                          }`}>
              ...
              <div className="card-body">
                ...
                {departmentCompliance ? (
                  <>
                    ...
                    <div className="mb-3 pb-3 border-bottom">
                      <small className="text-muted d-block mb-1">Compliance Rate</small>
                      <h4 
                        className="fw-bold mb-0" 
                        style={{ color: getComplianceColor(departmentCompliance.compliancePercentage) }}
                      >
                    ...
                    <div className="mb-3 pb-3 border-bottom">
                      <small className="text-muted d-block mb-1">Total SLAs</small>
                      <strong>{departmentCompliance.totalSlas}</strong>
                    </div>

                    <div className="mb-3 pb-3 border-bottom">
                      <small className="text-muted d-block mb-1">On Time</small>
                      <strong className="text-success">{departmentCompliance.onTimeSlas}</strong>
                    </div>

                    <div className="mb-0">
                      <small className="text-muted d-block mb-1">Breached</small>
                      <strong className="text-danger">{departmentCompliance.breachedSlas}</strong>
                    </div>
                  </>
                ) : (
            ...
            <div className="modal-content" style={{ borderRadius: '12px' }}>
              ...
              <div className="modal-body">
                <div className="mb-4 p-3" style={{ backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
                  ...
                  <div className="mb-2">
                    <small className="text-muted d-block">Manager (Escalated By)</small>
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    disabled={approvingEscalation}
                  />
                  <small className="text-muted mt-2 d-block">{resolutionComments.length}/500</small>
                </div>
              </div>
