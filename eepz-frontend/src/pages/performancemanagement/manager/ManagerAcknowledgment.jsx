...
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import ManagerAcknowledgmentModal from "../../../components/performance_management/modals/ManagerAcknowledgment/ManagerAcknowledgmentModal"; // Import the modal
...
export default function ManagerAcknowledgment() {
  ...
  return (
    <div className="manager-acknowledgment-container">
      <ToastContainer position="top-right" autoClose={3000} />
      <h2 className="manager-acknowledgment-title">Employee Acknowledgments</h2>

      {/* Button to open modal */}
      <button
        className="manager-acknowledgment-view-btn"
