...
import { ArrowLeft, AlertTriangle, Clock, User, Star, MessageSquare, Edit, Trash2 } from 'lucide-react';
...
export default function ManagerReviewDetail() {
  ...
  const managerName = employeeMap[review.managerEmployeeId] || `Manager ${review.managerEmployeeId}`;
  const employeeName = employeeMap[review.targetEmployeeId] || `Employee ${review.targetEmployeeId}`;
  ...
  return (
    <div className="container-fluid py-3" style={{ maxWidth: '900px' }}>
      ...
      <div className="d-flex gap-2 mb-4">
        ...
        <div>
          <h2 className="fw-bold mb-1" style={{ color: 'var(--color-primary-1)' }}>Review Details</h2>
          <p className="mb-0 small text-muted">Review ID: {review.reviewcommentId}</p>
        </div>
      </div>
        ...
        <div className="col-md-6">
          <div className="card border-0" style={{ border: '1px solid var(--border)' }}>
            <div className="card-body">
              <h5 className="mb-3" style={{ color: 'var(--color-primary-1)' }}>Review Information</h5>

              {/* Manager */}
              <div className="mb-3">
                <label className="form-label fw-bold small text-muted">From Manager:</label>
              ...
              {/* Employee */}
              <div className="mb-3">
                <label className="form-label fw-bold small text-muted">For Employee:</label>
                <div className="d-flex align-items-center gap-2">
                  <User size={16} style={{ color: 'var(--color-primary-1)' }} />
              ...
              <div className="mb-3">
                ...
                <span className="badge" style={{ backgroundColor: `${statusColor}20`, color: statusColor, padding: '6px 10px' }}>
                  {review.status}
                </span>
              </div>
              ...
              {/* Rating */}
              <div className="mb-3">
                <label className="form-label fw-bold small text-muted">Rating:</label>
                <div className="small">{'⭐'.repeat(review.rating || 0)}</div>
              </div>

              {/* Date */}
              <div className="mb-3">
                <label className="form-label fw-bold small text-muted">Date Created:</label>
                <div className="d-flex align-items-center gap-2 small">
                  <Clock size={14} style={{ color: 'var(--color-primary-3)' }} />
